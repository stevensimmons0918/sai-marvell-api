 ...
 */
typedef XP_STATUS(*xpOfPacketInHandler)(xpsDevice_t, xpDatapath_t,
                                        xpOfPacketIn_t *, void *);
 ...
 */
typedef XP_STATUS(*xpOfFlowStatsFlushHandler)(xpsDevice_t, xpDatapath_t,
                                              uint32_t, xpOfFlowId_t *, xpOfStats_t *, void *);
 ...
 * \return XP_STATUS
 */
XP_STATUS xpsOfCreateTable(xpsDevice_t devId,
                           xpOpenFlowTableProfile_t *tblInfo);
 ...
 * \return XP_STATUS
 */
XP_STATUS xpsOfDeleteTable(xpDevice_t devId,
 ...
 * \param [out] flowIdList  OpenFlow entry identifier
 *
 * \return XP_STATUS
 */
...
/**
 * \brief This method sets rehash level for Hash table
 *
 * \param [in] devId
 * \param [in] tableId
...
/**
 * \brief This method gets rehash level for Hash table
 *
 * \param [in] devId
 * \param [in] tableId
