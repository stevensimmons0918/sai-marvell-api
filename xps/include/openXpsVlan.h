 ...
 *
 */
typedef struct xpsVlanConfig_t
{
    ...
    xpsPktCmd_e
    bcCmd;                   ///< Broadcast packet type command
    xpsPktCmd_e
    unknownUcCmd;            ///< Unknown Unicast packet type command
    xpsPktCmd_e
    arpBcCmd;                ///< ARP Broadcast packet type command
    xpsVlanBridgeMcMode_e
    ipv4McbridgeMode;        ///< IPv4 Bridge Multicast Multicast configuration
    xpsVlanBridgeMcMode_e
    ipv6McbridgeMode;        ///< IPv6 Bridge Multicast Multicast configuration
    xpsPktCmd_e
    unRegMcCmd;              ///< Unregistered Multicast packet type command
    xpsPktCmd_e
    icmpv6Cmd;               ///< IPv6 ICMP packet type command
    xpsPktCmd_e           igmpCmd;                 ///< IGMP packet type command
} xpsVlanConfig_t;
...
/**
 * \brief This method adds an Tunnel Bridge Port End point to a specific VLAN instance in SW state.
 *
 * \param [in] devId Device ID
 * \param [in] vlanId VLAN ID
 * \param [in] intfId
...
/**
 * \brief This method removes an Tunnel Bridge Port End point from a specific VLAN instance from SW state.
 *
 * \param [in] devId Device ID
 * \param [in] vlanId VLAN ID
 * \param [in] intfId
