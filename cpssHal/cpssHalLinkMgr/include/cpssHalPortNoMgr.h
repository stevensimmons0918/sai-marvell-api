...
#ifndef _cpssHalPortNoMgr_h_
#define _cpssHalPortNoMgr_h_
...
XP_STATUS cpssHalMacNoMgrFecModeGet(xpsDevice_t devId, uint32_t portNum,
                                    xpFecMode *fecMode);
 ...
 * \return [XP_STATUS]  status On success XP_NO_ERR.
 */
XP_STATUS cpssHalMacNoMgrPortInitWithLinkStatusControl(xpsDevice_t devId,
...
XP_STATUS cpssHalMacNoMgrPortSerdesIsDfeRunning(xpsDevice_t devId,
                                                xpsPort_t portNum,
...
XP_STATUS cpssHalMacNoMgrPortSerdesIsDfeRunningDebug(xpsDevice_t devId,
...
XP_STATUS cpssHalPortNoMgrAutoNegEnable(xpsDevice_t devId, uint32_t portNum,
                                        uint16_t portANAbility, uint16_t portANCtrl);
 ...
 *
*/
XP_STATUS cpssHalMacNoMgrPortANLtRemoteAbilityGet(xpDevice_t devId,
                                                  uint32_t port,
