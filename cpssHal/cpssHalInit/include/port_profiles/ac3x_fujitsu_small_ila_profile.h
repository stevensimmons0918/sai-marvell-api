...
/*   Device 0
    ...
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = { 5,  5,  5, CPSS_PORT_INTERFACE_MODE_SGMII_E, 10, .phyInfo = {0, 0, 0, 0},  5}},
    ...
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = { 9,  9,  9, CPSS_PORT_INTERFACE_MODE_SGMII_E, 10, .phyInfo = {0, 0, 0, 0},  9}},
    ...
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {12, 12, 12, CPSS_PORT_INTERFACE_MODE_SGMII_E, 10, .phyInfo = {0, 0, 0, 0}, 12}},
    ...
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {15, 15, 15, CPSS_PORT_INTERFACE_MODE_1000BASE_X_E, 10, .phyInfo = {0, 0, 0, 0}, 15}},
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {16, 16, 16, CPSS_PORT_INTERFACE_MODE_1000BASE_X_E, 10, .phyInfo = {0, 0, 0, 0}, 16}},
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {17, 17, 17, CPSS_PORT_INTERFACE_MODE_SGMII_E, 10, .phyInfo = {0, 0, 0, 0}, 17}},
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {18, 18, 18, CPSS_PORT_INTERFACE_MODE_1000BASE_X_E, 10, .phyInfo = {0, 0, 0, 0}, 18}},
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {19, 19, 19, CPSS_PORT_INTERFACE_MODE_SGMII_E, 10, .phyInfo = {0, 0, 0, 0}, 19}},
    {.profileType = PROFILE_TYPE_PORT_MAP_E, .profileValue.portMap = {20, 20, 20, CPSS_PORT_INTERFACE_MODE_1000BASE_X_E, 10, .phyInfo = {0, 0, 0, 0}, 20}},
