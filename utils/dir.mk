...
$D/LIB_XPS_STATE := \
	$(REL_TOP)/utils/state/xpsRBTree.c \
	$(REL_TOP)/utils/state/xpsState.c 
$D/LIB_XPS_ALLOCATOR := \
    $(REL_TOP)/utils/allocator/xpsAllocatorMgr.cpp \
	$(REL_TOP)/utils/allocator/xpsBitVector.cpp \
    $(REL_TOP)/utils/allocator/xpsIdAllocatorCtx.cpp \
    $(REL_TOP)/utils/allocator/xpsIdAllocator.cpp \
    $(REL_TOP)/utils/allocator/xpsLockArr.cpp \
    $(REL_TOP)/utils/allocator/xpsLock.cpp \
    $(REL_TOP)/utils/allocator/xpsMutex.cpp \
    $(REL_TOP)/utils/allocator/xpsMutexDummy.cpp \
	$(REL_TOP)/utils/allocator/xpsMutexPosix.cpp \
    $(REL_TOP)/utils/allocator/xpsPersistBitVector.cpp
$D/LIB_XPS_SAL := \
	$(REL_TOP)/utils/sal/xpsSal.c
$D/LIB_SRCS := \
    $($D/LIB_XPS_STATE) \
    $($D/LIB_XPS_ALLOCATOR) \
    $($D/LIB_XPS_SAL)
