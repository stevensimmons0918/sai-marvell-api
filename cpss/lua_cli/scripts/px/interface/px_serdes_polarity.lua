...
local function serdes_polarity_func(params)
    ...
    if params.laneNum ~= "all" then
        ...
        if true == command_data["status"] then
            ...
            ret = myGenWrapper("cpssPxPortSerdesPolaritySet",{
      ...
      if true == command_data["status"] then
          ...
          if(nil~=devNum) then
                    ...
                    ret, localSerdesPolarityPtr = myGenWrapper("cpssPxPortInterfaceModeGet",{
                        {"IN","GT_SW_DEV_NUM","devNum",devNum},
                        {"IN","GT_PHYSICAL_PORT_NUM","portNum",portNum},
                    ...
                    ret, localSerdesPolarityPtr = myGenWrapper("prvCpssPxPortIfModeSerdesNumGet",{
                        {"IN","GT_SW_DEV_NUM","devNum",devNum},
                        {"IN","GT_PHYSICAL_PORT_NUM","portNum",portNum},
