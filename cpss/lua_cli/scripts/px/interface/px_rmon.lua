...
--rmon
local function px_rmon_func(params)
    local result, values
    ...
    if true == command_data["status"] then
        ...
        for iterator, devNum, portNum in command_data:getPortIterator() do
            ...
            if true == command_data["local_status"]  then
                result, values =
                    cpssPerPortParamSet("cpssPxPortMacCountersRxHistogramEnableSet",
                                        devNum, portNum,
            ...
            if true == command_data["local_status"]  then
                result, values =
                    cpssPerPortParamSet("cpssPxPortMacCountersTxHistogramEnableSet",
                                        devNum, portNum,
