...
--
local function clear_mac_counters_func(params, printFlag)
    ...
    if true == command_data["status"] then
        ...
        for iterator, devNum, portNum in command_data:getPortIterator() do
            ...
            if true == command_data["local_status"] then
				result, values= myGenWrapper("cpssPxPortMacCountersClearOnReadGet",{
            ...
            if false == port_skiped and false == clerOnReadStatus and true == command_data["local_status"] then	--enable clear on read only if was disable
                result, values =
                    cpssPerPortParamSet("cpssPxPortMacCountersClearOnReadSet",
            ...
            if false == port_skiped and true  == command_data["local_status"] then
                result, values =
                    cpssPerPortParamGet("cpssPxPortMacCountersOnPortGet",
                                                     devNum, portNum,
