...
--********************************************************************************
--* napt44_tunneling.lua
--*
--* DESCRIPTION:
--*       The test for NAPT+Tunneling:
...
do
    status, payload = pcall(dofile, "dxCh/examples/packets/napt44_tunneling.lua")
    if not status then
...
executeLocalConfig("dxCh/examples/configurations/napt44_tunneling.txt")
...
executeLocalConfig("dxCh/examples/configurations/napt44_tunneling_deconfig.txt")
