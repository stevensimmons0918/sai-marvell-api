...
--********************************************************************************
--* pop_push_passenger_vlan_tag.lua
--*
--* DESCRIPTION:
--*       The test for pop push passenger vlan tag feature
--*
...
do
    status, payload = pcall(dofile, "dxCh/examples/packets/pop_push_passenger_vlan_tag.lua")
    if not status then
...
executeLocalConfig("dxCh/examples/configurations/pop_push_passenger_vlan_tag.txt")
...
executeLocalConfig("dxCh/examples/configurations/pop_push_passenger_vlan_tag_deconfig.txt")
