...
--********************************************************************************
--* capwap_ipv4_ap_to_ap.lua
--*
--* DESCRIPTION:
--*       The test for testing capwap ipv4 ap_to_ap feature
--*
...
do
    status, payloads = pcall(dofile, "dxCh/examples/packets/capwap_ipv4_ap_to_ap.lua")
    if not status then
...
--------------------------------------------------------------------------------
executeLocalConfig("dxCh/examples/configurations/capwap_ipv4_ap_to_ap.txt")
...
executeLocalConfig("dxCh/examples/configurations/capwap_ipv4_ap_to_ap_deconfig.txt")
