...
--[[  0. cpssInitSystem PEX only
      ...
      system description:
      1.    ports 0,8 belong to vlan 1.
      2.    port 0 is in 'loopback' mode.
      3.    sending packet with 'dsa' tag 'from_cpu' to port port 63.
      4.    the packet egress from port 0 without 'dsa' tag on vlan 1.
...
local broadcast_1_to_all_vlan_1_packet = ""..
...
return  { broadcast_1_to_all_vlan_X = broadcast_1_to_all_vlan_1_packet}
