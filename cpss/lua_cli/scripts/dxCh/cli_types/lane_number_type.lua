...
function getSpeedIdx(mode)
    if mode=="_10_3125G" or mode == "_10_3125G_SR_LR" or mode == "_10_9375G" then
        return 0 --CPSS_PM_AP_LANE_SERDES_SPEED_10000_E
    elseif mode == "_25_78125G" or mode == "_25_78125G_SR_LR" or mode == "_27_34375G" then
        return 1 --CPSS_PM_AP_LANE_SERDES_SPEED_25000_E
    elseif mode == "_26_5625G_PAM4" or mode == "_26_5625G_PAM4_SR_LR" or mode == "_28_125G_PAM4" then
        return 2 --CPSS_PM_AP_LANE_SERDES_SPEED_PAM4_E
    else
        return 3 --CPSS_PM_AP_LANE_SERDES_SPEED_NONE_E
    end
end
...
local function check_lane_number(param, name, desc)
    ...
    result, portmgrEn = myGenWrapper("cpssDxChPortManagerEnableGet",
