...
-- ************************************************************************
---
--  CLI_check_param_hop_entry_name
--        @description  This function validates that the string s is a 
--                      valid hop entry name, it accepts lower/upper case 
...
--
local function CLI_check_param_hop_entry_name(s)
    local status
	local i, c
    ...
    if true == status then
        ...
        return false, "The hop entry name is invalid"
    end
end

-- ************************************************************************
---
--  CLI_complete_param_hop_entry_name
--        @description  complete hop entry name
--
--        @param param          - checked parameter value
--        @param name           - checked parameter name
--        @param desc           - checked parameter range
--
--        @return       complete hop entry name and help lists
--
local function CLI_complete_param_hop_entry_name(param, name, desc)
    local values = 
...
CLI_type_dict["hop-entry-name"] = {
    checker  = CLI_check_param_hop_entry_name,
    complete = CLI_complete_param_hop_entry_name,
    help     = "Hop entry name"
} 