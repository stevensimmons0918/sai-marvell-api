...
---
--  dfx_write
--        @description  Writes to a dfx
--
--        @param params         - The parameters
--
--        @return       true if there was no error otherwise false
--
local function dfx_write(params)
...
-- *debug*
-- dfx write device %devID offset %GT_U32_hex mask %GT_U32_hex
CLI_addCommand("debug", "dfx-register write", {
    func = dfx_write,
    help = "Write to a dfx",
    params={
        { type="named",
