...
#define INTER_REGS_BASE		( 0x10080000 )
#define MV_CPU_LE
...
#define CONFIG_HOST2POE_IRQ_ENABLE
...
/* armv5 gnueabi compiler does not have dmb() yet mv_ipc.c needs dmb(), so define dmb() here */
#define dmb()				cpu_flush_wb()
