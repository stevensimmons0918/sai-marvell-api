...
#define LEDBIT_OUT( p )			( 1 << (( p ) % 32 ) )
#define LEDBIT_0				( 26 )
#define LEDBIT_1				( 27 )
#define LEDBIT_2				( 48 )

/* Soft Reset control */
#define SYSREG_RSTOUT			( 0x18260 )
#define SYSREG_SOFT_RESET		( 0x18264 )
...
#define MV_CFU_CONFIG_REG				( MV_COHERENCY_FABRIC_OFFSET + 0x28 )
...
#define CPU_SNOOP_FILTER_CTRL_REG( cpu ) ( MV_CPUIF_REGS_BASE( cpu ) + 0x20 )
#define CPU_SNOOP_FILTER_ENABLE			( 0x1 )
#define CPU_SNOOP_FILTER_INVALIDATE		( 0x100 )
