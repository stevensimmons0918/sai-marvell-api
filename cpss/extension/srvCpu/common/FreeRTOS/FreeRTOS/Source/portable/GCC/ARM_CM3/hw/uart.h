...
/* CONFIG_A8K and palladium not in use for now if will be these definitions
    will overwrite definitions above */
#ifdef CONFIG_A8K
#define MV_UART_REGS_OFFSET( port ) ( 0x40512000 | 0x100 * ( port ))
#define MV_UART_FIFO_SIZE           ( 16 )
#endif

#ifdef CONFIG_A8K_PALLADIUM
#define MV_UART_DIV                 ( 1 )
#endif
