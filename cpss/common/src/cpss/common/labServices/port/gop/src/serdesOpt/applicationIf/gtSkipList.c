...
* @file gtSkipList.c
*
* @brief This file includes a generic skip-list implementation, it provides the
...
/**
* @internal skipAdd2DownLevelAndGetNode function
* @endinternal
*
* @brief   Adds a new node to the skipList at the lowest level.
*
* @param[in] pSlHead                  - A pointer to the skipList to which this node is added.
* @param[in] pData                    - A pointer to the new data to be added.
*
* @param[out] addedNode                - Points to the new added node as a result of the insertion.
...
/**
* @internal skipAdd2DownLevel function
* @endinternal
*
* @brief   Adds a new node to the skipList at the lowest level.
*
...
/**
* @internal toss function
* @endinternal
*
* @brief   returns 0 or 1 in equal probability.
*/
static int toss()
{
