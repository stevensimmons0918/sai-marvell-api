...
********************************************************************/
#ifndef MCESD_C28GP4X4_REGRW_H
#define MCESD_C28GP4X4_REGRW_H
...
CPSS_ADDITION_START
#define C28GP4X4_WRITE_FIELD(xDevPtr, xField, xLane, xData)          {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C28GP4X4_WriteField(xDevPtr, xLane, &tempField, xData));}
#define C28GP4X4_READ_FIELD(xDevPtr, xField, xLane, xData)           {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C28GP4X4_ReadField(xDevPtr, xLane, &tempField, &xData));}
#define C28GP4X4_POLL_FIELD(xDevPtr, xField, xLane, xData, xTimeout) {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C28GP4X4_PollField(xDevPtr, xLane, &tempField, xData, xTimeout));}
CPSS_ADDITION_END
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  pin - enum of type E_C28GP4X4_PIN
@param[in]  value - value to match
@param[in]  timeout_ms - timeout in milliseconds
...
#endif /* defined MCESD_C28GP4X4_REGRW_H */
