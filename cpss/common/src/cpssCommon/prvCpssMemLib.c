...
/**
* @internal mmuCompareNodes function
* @endinternal
*
* @brief   Compares two memory nodes data, and returns one of the following
...
* @param[in] memPtr                   - a pointer to memory block to be added.
* @param[in] memSize                  the size (in bytes) of the memory block to be added.
...
/**
* @internal mmuGroup function
* @endinternal
*
* @brief   Gets two nodes and checks if they are sequenced in the memory.
*         if the two nodes can be combined then the first one remains in the
*         skipList and the second one is removed.
* @param[in] poolId                   - A pointer to memory pool.
* @param[in] first                    - A pointer to the  memData to be combined.
* @param[in] second                   - A pointer to the  memData to be combined.
*
* @retval GT_OK                    - if the two nodes where combined,
