 ...
 *
 * @brief enumerator for structured data type or sizeof integer data.
 ...
 *
 * @brief the enum defines type of the context value.
...
typedef enum{
    ...
    /** @brief condition structure pointer
    ...
    /** @brief 32-bit max-value for structured
     *  field value check
     */
 ...
 *
 * @brief the context management commands related to the
 ...
 *
 * @brief the value convert commands
*/
typedef enum{
 ...
 *
 * @brief the value check commands
*/
typedef enum{

    /** @brief check stc value by maximal
    ...
    /** @brief check the value to be less
 ...
 *
 * @brief Field SW structure to raw value conversion
*/
typedef struct{
 ...
 *
 * @brief Field to calculate and check condition
...
typedef struct{
    ...
    /** @brief type of field which contains value to
     *  compare with the pattern
     */
    CPSS_FORMAT_CONVERT_FIELD_TYPE_ENT fieldTypeOrSizeOf;

    /** @brief offset (in bytes from SW structure origin) of
    ...
    /** mask in structured data format */
    GT_U32 mask;

    /** @brief pattern in structured data format
     *  Comments:
     */
    GT_U32 pattern;
