/**
********************************************************************************
* @file presteraPpDriverGlob.h
*
* @brief This file includes the declaration of the struct we want to send to kernel mode,
* from user mode.
*
*/
/*******************************************************************************
...
*
*******************************************************************************/
#ifndef __PRESTERA_PP_DRIVER_GLOBH__
#define __PRESTERA_PP_DRIVER_GLOBH__
 ...
 *                                  Bobcat2, Caelum, Bobcat3, Aldrin, AC3X only now
 */
enum mvPpDrvDriverType_ENT {
...
#endif /* __PRESTERA_PP_DRIVER_GLOBH__ */
