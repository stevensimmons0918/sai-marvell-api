...
/************* Typedefs *******************************************************/
/**
* @enum CPSS_OS_INTR_MODE_ENT
 *
 * @brief An enumeration for interrupts mode
*/
typedef enum{
...
/*******************************************************************************
* CPSS_OS_INT_DISCONNECT_FUNC
*
* DESCRIPTION:
*       Disconnect a specified C routine from specified interrupt vector.
*
* INPUTS:
*       vector    - interrupt vector number to detach
*
* OUTPUTS:
*       None
*
...
*
*******************************************************************************/
typedef GT_STATUS (*CPSS_OS_INT_DISCONNECT_FUNC)
(
    IN  GT_U32           vector
);
