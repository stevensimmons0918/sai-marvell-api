...
* @file cpssOsSocket.h
*
* @brief extended operating system wrapper library implements TCP/IP and UDP/IP
...
/**
* @enum CPSS_SOCKET_SHUTDOWN_OPERATION
 *
 * @brief enum that describes what types of operation will no longer be allowed
 * Comments:
*/
typedef enum{

    CPSS_SOCKET_SHUTDOWN_CLOSE_INPUT,

    CPSS_SOCKET_SHUTDOWN_CLOSE_OUTPUT,

    CPSS_SOCKET_SHUTDOWN_CLOSE_ALL
