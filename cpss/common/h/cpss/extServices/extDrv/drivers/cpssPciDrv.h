...
/*******************************************************************************
* CPSS_EXTDRV_PCI_SET_DEV_ID_FUNC
*
* DESCRIPTION:
*        This routine will set pci device id in driver dhadow
*
* INPUTS:
*        devId - pci device id
*
...
*
*******************************************************************************/
typedef GT_STATUS (*CPSS_EXTDRV_PCI_SET_DEV_ID_FUNC)
(
    IN  GT_U16  devId
);
