...
* @file cpssIntDrv.h
*
* @brief Includes interrupt management routines.
*
* @version   1
********************************************************************************
*/
...
/*******************************************************************************
* CPSS_EXTDRV_INT_DISCONNECT_FUNC
*
* DESCRIPTION:
*       Disconnect specified interrupt vector.
*
* INPUTS:
...
*
*******************************************************************************/
typedef GT_STATUS (*CPSS_EXTDRV_INT_DISCONNECT_FUNC)
(
    IN  GT_U32           vector
);
/*******************************************************************************
