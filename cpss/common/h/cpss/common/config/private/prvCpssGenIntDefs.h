...
/**
* @struct PRV_CPSS_AU_DESC_EXT_5_STC
 *
 * @brief Includes fields definitions of the Address Update messages sent
...
typedef struct{
    ...
    /** word#4 of AU descriptor */
    GT_U32 word4;

    /** word#5 of AU/FU message with no data */
    GT_U32 unusedWord5;

    /** word#6 of AU/FU message with no data */
    GT_U32 unusedWord6;

    /** word#7 of AU/FU message with no data */
    GT_U32 unusedWord7;
