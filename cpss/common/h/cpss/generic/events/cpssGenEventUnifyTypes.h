 ...
 typedef enum
{
    ...
    CPSS_PP_HSR_PRP_PNT_NUM_OF_READY_ENTRIES_E                                ,  /* 634 */

    CPSS_PP_STREAM_LATENT_ERROR_E                                             ,  /* 635 */

    /**************************** AC5 CM3 events **************************/
    CPSS_PP_CM3_WD_E                                                          ,  /* 636 */
    CPSS_PP_CM3_DOORBELL_E                                                    ,  /* 637 */
    ...
    /**************************** SRVCPU EVENTS *******************************/
    CPSS_SRVCPU_IPC_E                                                         ,  /* 638 */
    CPSS_SRVCPU_PORT_LINK_STATUS_CHANGED_E                                    ,  /* 639 */
    CPSS_SRVCPU_PORT_802_3_AP_E                                               ,  /* 640 */
    CPSS_SRVCPU_PORT_REMOTE_FAULT_TX_CHANGE_E                                 ,  /* 641 */
    CPSS_SRVCPU_PORT_AP_DISABLE_E                                             ,  /* 642 */
    CPSS_SRVCPU_RESERVED_5                                                    ,  /* 643 */
    CPSS_SRVCPU_RESERVED_6                                                    ,  /* 644 */
    CPSS_SRVCPU_RESERVED_7                                                    ,  /* 645 */
    CPSS_SRVCPU_RESERVED_8                                                    ,  /* 646 */
    CPSS_SRVCPU_RESERVED_9                                                    ,  /* 647 */
    CPSS_SRVCPU_MAX_E = CPSS_SRVCPU_RESERVED_9                                ,  /* 647 */

    /************************** Xbar events ***********************************/
    CPSS_XBAR_UNI_EV_MIN_E                         = (CPSS_SRVCPU_MAX_E+1) ,     /* 648 */

    CPSS_XBAR_HG_LANE_SYNCH_CHANGE_E               = (CPSS_XBAR_UNI_EV_MIN_E) ,   /* 648 */
    CPSS_XBAR_HG_LANE_COMMA_ALIGN_CHANGE_E                                    ,   /* 649 */
    CPSS_XBAR_GPORT_INVALID_TRG_DROP_CNT_INC_E                                ,   /* 650 */
    CPSS_XBAR_GPORT_DIAG_CELL_RX_CNTR_INC_E                                   ,   /* 651 */
    CPSS_XBAR_MISC_E                                                          ,   /* 652 */
    CPSS_XBAR_HG_PING_RECEIVED_E                                              ,   /* 653 */
    CPSS_XBAR_HOST_RX_FIFO_PEND_E                                             ,   /* 654 */
    CPSS_XBAR_HOST_SEND_CELL_E                                                ,   /* 655 */
    CPSS_XBAR_HG_ALIGNMENT_LOCK_CHANGE_E                                      ,   /* 656 */
    CPSS_XBAR_HG_PING_E                                                       ,   /* 657 */
    CPSS_XBAR_SD_INV_ADDR_E                                                   ,   /* 658 */
    CPSS_XBAR_SXBAR_INV_ADDR_E                                                ,   /* 659 */
    CPSS_XBAR_S_INV_ADDR_E                                                    ,   /* 660 */
    CPSS_XBAR_G_INV_ADDR_E                                                    ,   /* 661 */
    CPSS_XBAR_MC_INV_ADDR_E                                                   ,   /* 662 */

    CPSS_XBAR_UNI_EV_DUMMY_MAX_E,/* dummy -- must be 1 before CPSS_XBAR_UNI_EV_MAX_E */ /* 663 */

    CPSS_XBAR_UNI_EV_MAX_E                        = (CPSS_XBAR_UNI_EV_DUMMY_MAX_E-1),  /* 662 */

    /************************** Fa events *************************************/
    CPSS_FA_UNI_EV_MIN_E                        = (CPSS_XBAR_UNI_EV_MAX_E + 1)  , /* 663 */

    CPSS_FA_UC_PRIO_BUF_FULL_E                    = (CPSS_FA_UNI_EV_MIN_E)    ,   /* 663 */
    CPSS_FA_MC_PRIO_BUF_FULL_E                                                ,   /* 664 */
    CPSS_FA_UC_RX_BUF_FULL_E                                                  ,   /* 665 */
    CPSS_FA_MC_RX_BUF_FULL_E                                                  ,   /* 666 */
    CPSS_FA_WD_FPORT_GRP_E                                                    ,   /* 667 */
    CPSS_FA_MC_WD_EXP_E                                                       ,   /* 668 */
    CPSS_FA_GLBL_DESC_FULL_E                                                  ,   /* 669 */
    CPSS_FA_MAC_UPD_THRS_E                                                    ,   /* 670 */
    CPSS_FA_DROP_DEV_EN_E                                                     ,   /* 671 */
    CPSS_FA_MISC_I2C_TIMEOUT_E                                                ,   /* 672 */
    CPSS_FA_MISC_STATUS_E                                                     ,   /* 673 */

    CPSS_FA_UNI_EV_DUMMY_MAX_E,/* dummy -- must be 1 before CPSS_FA_UNI_EV_MAX_E */  /* 674 */

    CPSS_FA_UNI_EV_MAX_E                          = (CPSS_FA_UNI_EV_DUMMY_MAX_E-1)   , /* 673 */

    /************************** DRAGONITE events *************************************/
    CPSS_DRAGONITE_UNI_EV_MIN_E                         = (CPSS_FA_UNI_EV_MAX_E + 1), /* 674 */

    CPSS_DRAGONITE_PORT_ON_E                = (CPSS_DRAGONITE_UNI_EV_MIN_E)   ,  /* 674 */
    CPSS_DRAGONITE_PORT_OFF_E                                                 ,  /* 675 */
    CPSS_DRAGONITE_DETECT_FAIL_E                                              ,  /* 676 */
    CPSS_DRAGONITE_PORT_FAULT_E                                               ,  /* 677 */
    CPSS_DRAGONITE_PORT_UDL_E                                                 ,  /* 678 */
    CPSS_DRAGONITE_PORT_FAULT_ON_STARTUP_E                                    ,  /* 679 */
    CPSS_DRAGONITE_PORT_PM_E                                                  ,  /* 680 */
    CPSS_DRAGONITE_POWER_DENIED_E                                             ,  /* 681 */
    CPSS_DRAGONITE_OVER_TEMP_E                                                ,  /* 682 */
    CPSS_DRAGONITE_TEMP_ALARM_E                                               ,  /* 683 */
    CPSS_DRAGONITE_DEVICE_FAULT_E                                             ,  /* 684 */
    CPSS_DRAGONITE_OVER_CONSUM_E                                              ,  /* 685 */
    CPSS_DRAGONITE_VMAIN_LOW_AF_E                                             ,  /* 686 */
    CPSS_DRAGONITE_VMAIN_LOW_AT_E                                             ,  /* 687 */
    CPSS_DRAGONITE_VMAIN_HIGH_E                                               ,  /* 688 */
    CPSS_DRAGONITE_READ_EVENT_E                                               ,  /* 689 */
    CPSS_DRAGONITE_WRITE_EVENT_E                                              ,  /* 690 */
    CPSS_DRAGONITE_ERROR_E                                                    ,  /* 691 */
