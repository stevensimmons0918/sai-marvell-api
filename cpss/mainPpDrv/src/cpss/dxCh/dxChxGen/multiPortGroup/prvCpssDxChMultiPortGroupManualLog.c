...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_PORT_NUM_ARRAY_uplinkPortsArr = {
     "uplinkPortsArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_PORT_NUM)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMultiPortGroupConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_numOfUplinkPorts,
    &DX_IN_GT_PORT_NUM_ARRAY_uplinkPortsArr,
    &DX_IN_GT_U32_ringInfoNum,
    &DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_RING_INFO_STC_PTR_ringInfoArr
};
