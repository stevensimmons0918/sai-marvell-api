...
/**
********************************************************************************
* @file prvCpssDxChPortPizzaArbiterTablesLionB0_240MHz_8x10G.c
*
* @brief Pizza arbiter Table for Lion2 B0 240 MHz clock (8x10G ports 8 slices)
*
* @version   11
********************************************************************************
*/
...
#if 0
const CPSS_DXCH_PORT_SPEED_TO_SLICE_NUM_STC portSpeed2SliceNumListLionB0_240Mhz_8x10G[] = 
{     /* port speed        ,     slices N */
...
CPSS_DXCH_PORT_PIZZA_PORTGROUP_SPEED_TO_SLICENUM_STC prvPortGroupPortSpeed2SliceNumLionB0_240Mhz_8x10G = 
{
    /* 12 */
    {
