...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_eventsArr = {
     "eventsArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpfixAlarmEventsGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_POLICER_STAGE_TYPE_ENT_stage,
    &DX_OUT_GT_U32_ARRAY_eventsArr,
    &DX_OUT_GT_U32_PTR_eventsNumPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpfixPortGroupAlarmEventsGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
