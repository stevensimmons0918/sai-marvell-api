...
/**
* @struct PRV_CPSS_DXCH_TCAM_MANAGER_INDEX_RANGE_STC
 *
 * @brief Holds indexes range.
*/
typedef struct{
...
/**
* @struct PRV_CPSS_DXCH_TCAM_MANAGER_CLIENT_STC
 *
 * @brief Holds TCAM manager client information.
*/
typedef struct{

    /** whether this entry represent registered client */
    ...
    /** @brief whether the reservation type is locked;
    ...
    /** @brief the reservation range; relevant only when reservation
...
/**
* @struct PRV_CPSS_DXCH_TCAM_MANAGER_ENTRY_INFO_STC
 *
 * @brief Holds information for each of the entries in the TCAM.
*/
typedef struct{

    /** whether this entry is allocated or not */
    GT_BOOL isUsed;

    /** the entry type */
    CPSS_DXCH_TCAM_MANAGER_ENTRY_TYPE_ENT type;

    /** @brief the client that allocated this entry
    ...
    /** token pointing to this entry */
    GT_U32 token;

} PRV_CPSS_DXCH_TCAM_MANAGER_ENTRY_INFO_STC;

/**
* @struct PRV_CPSS_DXCH_TCAM_MANAGER_STC
 *
 * @brief Holds TCAM manager information.
*/
typedef struct{
    ...
    /** the TCAM range allocated to the TCAM manager */
    CPSS_DXCH_TCAM_MANAGER_RANGE_STC tcamRange;

    /** @brief holds constant value to verify that the TCAM
     *  manager handler is valid
     */
    GT_U32 validityValue;

    /** number of TCAM lines in the TCAM manager */
    GT_U32 tcamLines;

    /** number of TCAM entries in the TCAM manager */
    GT_U32 tcamEntries;
    ...
    /** size of token to index array */
    GT_U32 tokenToIndexArraySize;

    /** next free token in the token to index array */
...
/**
* @internal entryTypeSizeGet function
* @endinternal
*
* @brief   Returns the number of TCAM entries that entry type takes.
*
* @param[in] entryType                - the entry type
*                                       The number of TCAM entries that the entry type takes.
*
* @note The entryType must be valid one.
*
*/
...
/**
* @internal entryTypeToArrayIndex function
* @endinternal
*
* @brief   Converts entry type to array index. Used in ordered arrays, that have
...
/**
* @internal arrayIndexToEntryType function
* @endinternal
*
* @brief   Converts array index to entry type. Used in ordered arrays, that have
*         specific array index per entry type.
* @param[in] arrayIndex               - the entry type
*                                       The entry type.
*
* @note The arrayIndex must be valid.
*
*/
...
/**
* @internal convertIndexToToken function
* @endinternal
*
* @brief   Converts index of token. The index is relative to the first
*         line of the TCAM section managed by the TCAM manager.
*         The TCAM manager maintains array of entries information. The token is
*         implemented as a pointer to the element in the array that is
*         associated with the entry.
...
*
* @param[out] tokenPtr                 - points to token representing the index
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_FAIL                  - on error
...
/**
* @internal compareCandidatesForFree function
* @endinternal
*
* @brief   Compares two candidates to free during defragment.
*
* @param[in] tcamManagerPtr           - the TCAM manager object
* @param[in] firstCandidate           - index of first candidate
* @param[in] compareToSecond          - GT_TRUE:  compare to second candidate
*                                      GT_FALSE: compare to worst case candidate
* @param[in] secondCandidate          - index of second candidate, relevant only
*                                      when compareToSecond == GT_TRUE
* @param[in] entryType                - entry type to free space for
*
* @param[out] resultPtr                - points to the comparison results:
...
/**
* @internal freeIndex function
* @endinternal
*
* @brief   Free space starting at specific index for an entry type.
*
* @param[in] tcamManagerPtr           - the TCAM manager object
* @param[in] entryType                - entry type to free space for
* @param[in] indexToFree              - starting index
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
* @retval GT_BAD_PTR               - on NULL pointer
...
/**
* @internal setEntryUsage function
* @endinternal
*
* @brief   Mark entry that resides at specific index as used/unused. If marking
*         the entry as used, also fill in the entry information.
* @param[in] tcamManagerPtr           - the TCAM manager object
* @param[in] index                    -  to mark
* @param[in] entryType                - entry type to free space for
* @param[in] isUsed                   - GT_TRUE:  mark as used
*                                      GT_FALSE: mark as free
* @param[in] clientId                 - client that allocated this entry
* @param[in] clientCookiePtr          - client cookie; used in client callback functions
* @param[in] token                    -  assiciated with this entry
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_OUT_OF_RANGE          - index is out of the range managed by TCAM manager
* @retval GT_FAIL                  - on error
*/
...
/**
* @internal tcamEntriesNeededForAllocatedAndReservedEntries function
* @endinternal
*
* @brief   Gets the number of TCAM entries needed to hold the already allocated
...
* @param[in] tcamManagerPtr           - the TCAM manager object
*
* @param[out] tcamEntriesNeededPtr     - points to tcam entries needed
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_FAIL                  - on error
...
/**
* @internal isLineWithinRange function
* @endinternal
*
* @brief   Checks if a line is within a range of lines.
*
* @param[in] line                     - the line
* @param[in] rangePtr                 - points to the range
*                                       GT_TRUE:  the line is within the range
*                                       GT_FALSE:  otherwise
*
* @note The range must be a valid range.
*
*/
...
/**
* @internal entryAllocatePrepareSearchParameters function
* @endinternal
*
* @brief   Prepares search parameters for entry allocation function.
*
* @param[in] tcamManagerPtr           - the TCAM manager handler
* @param[in] clientPtr                - ptr to the TCAM manager client
* @param[in] entryType                - entry type required
* @param[in] lowerBoundToken          - lower bounding token
* @param[in] upperBoundToken          - upper bounding token
* @param[in] allocMethod              - allocation method required
*
* @param[out] lowerBoundIndexPtr       - lower bounding index
* @param[out] upperBoundIndexPtr       - upper bounding index
* @param[out] lowerBoundLineIndexPtr   - lower bounding line index
* @param[out] upperBoundLineIndexPtr   - upper bounding line index
* @param[out] searchLineIndexPtr       - search line index
* @param[out] midAllocLowerPtr         - middle allocation of lower index
* @param[out] midAllocUpperPtr         - middle allocation of upper index
*
* @retval GT_OK                    - on success
...
/**
* @internal entryAllocateGetNextSearchLine function
* @endinternal
*
* @brief   Prepares search parameters for entry allocation function.
*
* @param[in] tcamManagerPtr           - the TCAM manager handler
* @param[in] clientPtr                - ptr to the TCAM manager client
* @param[in] lowerBoundIndex          - lower bounding index
* @param[in] upperBoundIndex          - upper bounding index
* @param[in] allocMethod              - allocation method required
* @param[in,out] searchLineIndexPtr       - search line index
* @param[in,out] midAllocLowerPtr         - middle allocation of lower ptr
* @param[in,out] midAllocUpperPtr         - middle allocation of upper ptr
* @param[in,out] searchLineIndexPtr       - search line index ptr
* @param[in,out] midAllocLowerPtr         - middle allocation of lower ptr
* @param[in,out] midAllocUpperPtr         - middle allocation of upper ptr
*
* @retval GT_OK                    - on success
...
/**
* @internal internal_cpssDxChTcamManagerCreate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerConfigGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerDelete function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerRangeUpdate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerClientRegister function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerClientUnregister function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerClientFuncUpdate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerEntriesReservationSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerEntriesReservationGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerUsageGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerDump function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerEntryAllocate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerEntryClientCookieUpdate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerEntryFree function
* @endinternal
*
* @brief   Frees entry.
*
...
/**
* @internal internal_cpssDxChTcamManagerAvailableEntriesCheck function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerTokenToTcamLocation function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerTokenCompare function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerTokenInfoGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerHsuSizeGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerHsuExport function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerHsuImport function
* @endinternal
*
...
/**
* @internal internal_cpssDxChTcamManagerHsuInactiveClientDelete function
* @endinternal
*
