...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_2_allocatedEntriesArray = {
     "allocatedEntriesArray", PRV_CPSS_LOG_PARAM_OUT_E, prvCpssLogParamFunc_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_sizeSet
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_CHAR_ARRAY_clientNameArr = {
     "clientNameArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_CHAR)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamManagerUsageGet_PARAMS[] =  {
    &DX_IN_GT_VOID_PTR_tcamManagerHandlerPtr,
    &DX_IN_GT_BOOL_usageOfSpecificClient,
    &DX_IN_GT_U32_clientId,
    &DX_OUT_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_reservedEntriesArray,
    &DX_INOUT_GT_U32_PTR_sizeOfReservedArrayPtr,
    &DX_OUT_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_2_allocatedEntriesArray,
    &DX_INOUT_GT_U32_PTR_sizeofAllocatedArrayPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamManagerClientRegister_PARAMS[] =  {
    &DX_IN_GT_VOID_PTR_tcamManagerHandlerPtr,
    &DX_IN_GT_CHAR_ARRAY_clientNameArr,
    &DX_IN_CPSS_DXCH_TCAM_MANAGER_CLIENT_FUNC_STC_PTR_clientFuncPtr,
    &DX_OUT_GT_U32_PTR_clientIdPtr
};
