...
/********* enums *********/
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_ARRAY_laneSyncOkArr = {
     "laneSyncOkArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_BOOL)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChFabricHGLinkPcsRxStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_GT_BOOL_ARRAY_laneSyncOkArr
};
