...
/**
********************************************************************************
* @file prvCpssDxChLpmTcamHsu.c
*
* @brief the CPSS DXCH LPM Hitless software upgrade for Hierarchy manager .
*
* @version   29
********************************************************************************
*/
...
/**
* @internal ipLpmDbGetL3TcamManager function
* @endinternal
*
* @brief   Retrieves the TCAM manager (in case of internal TCAM manager mode)
*
* @note   APPLICABLE DEVICES:      xCat3; AC5.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] ipTcamShadowPtr          - (pointer to)the shadow to retrieve from iter
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes supposed to be processed
*                                      in current iteration
*
* @param[out] tableSizePtr             - (pointer to)the table size calculated (in bytes)
* @param[out] tablePtrPtr              - (pointer to)the table size info block
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes left after iteration step.
*
* @retval GT_OK                    - on success
*
* @note For TCAM manager, the size of each entry is PRV_CPSS_IP_LPM_HSU_TCAM_MANAGER_ENTRY_SIZE_CNS
...
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] ipTcamShadowPtr          - (pointer to)the shadow to retrive from iter
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes supposed to be processed
*                                      in current iteration
*
...
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] ipTcamShadowPtr          - (pointer to)the shadow to retrive from
...
/**
* @internal ipLpmDbSetL3TcamManager function
* @endinternal
*
* @brief   Sets the TCAM manager (in case of internal TCAM manager mode)
*
* @note   APPLICABLE DEVICES:      xCat3; AC5.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] ipTcamShadowPtr          - (pointer to)the shadow to retrieve from iter
* @param[in] tablePtrPtr              - (pointer to)the table size info block
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes supposed to be processed
*                                      in current iteration
* @param[in,out] iterPtr                  - (pointer to)the current iter
...
* @endinternal
*
* @brief   sets the valid virtual routers
*
* @note   APPLICABLE DEVICES:      xCat3; AC5.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
* @endinternal
*
* @brief   Set the data needed for core uc prefix IP shadow reconstruction used
*         after HSU.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] ipTcamShadowPtr          - (pointer to)the shadow to set in
* @param[in] protocolStack            - type of ip protocol stack to work on.
* @param[in] tablePtrPtr              - (pointer to)the table size info block
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes supposed to be processed
...
*                                      in current iteration
*
* @param[out] tablePtrPtr              - (pointer to)where we stopped in the block
* @param[in,out] iterPtr                  - (pointer to)the current iter
* @param[in,out] dataSizePtr              - (pointer to) data size in bytes left after iteration step.
*
* @retval GT_OK                    - on success
...
*
* @note Refer to prvCpssDxChLpmTcamDbGet.
*
*/
