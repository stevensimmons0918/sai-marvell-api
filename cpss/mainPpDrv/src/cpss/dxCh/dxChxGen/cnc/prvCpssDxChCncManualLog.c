...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_indexesArr = {
     "indexesArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_portGroupIdArr = {
     "portGroupIdArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncCounterWraparoundIndexesGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_blockNum,
    &DX_INOUT_GT_U32_PTR_indexNumPtr,
    &DX_OUT_GT_U32_ARRAY_indexesArr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncPortGroupCounterWraparoundIndexesGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_blockNum,
    &DX_INOUT_GT_U32_PTR_indexNumPtr,
    &DX_OUT_GT_U32_ARRAY_portGroupIdArr,
    &DX_OUT_GT_U32_ARRAY_indexesArr
};
