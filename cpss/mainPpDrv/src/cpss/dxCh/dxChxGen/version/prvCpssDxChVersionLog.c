...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_VERSION_INFO_STC_PTR_versionPtr = {
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVersionGet_PARAMS[] =  {
    &DX_OUT_CPSS_VERSION_INFO_STC_PTR_versionPtr
};


/********* lib API DB *********/

static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChVersionLogLibDb[] = {
    {"cpssDxChVersionGet", 1, cpssDxChVersionGet_PARAMS, NULL},
};

/******** DB Access Function ********/
void prvCpssLogParamLibDbGet_DX_CPSS_LOG_LIB_VERSION(
