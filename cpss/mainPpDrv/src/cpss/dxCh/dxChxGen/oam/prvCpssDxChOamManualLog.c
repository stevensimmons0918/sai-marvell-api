...
/********* enums *********/
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_groupStatusArr = {
     "groupStatusArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChOamExceptionGroupStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_OAM_STAGE_TYPE_ENT_stage,
    &DX_IN_CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT_exceptionType,
    &DX_OUT_GT_U32_ARRAY_groupStatusArr
};
