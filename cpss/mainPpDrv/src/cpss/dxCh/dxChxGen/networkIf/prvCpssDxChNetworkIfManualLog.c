...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_PACKET_PTR_ARRAY_rxBuffList = {
     "rxBuffList", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_ARRAY_MAC(PACKET)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_PTR_ARRAY_rxBuffList = {
     "rxBuffList", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_ARRAY_MAC(GT_U8)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_rxBuffSizeList = {
     "rxBuffSizeList", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_PACKET_PTR_ARRAY_packetBuffsArrPtr = {
     "packetBuffsArrPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_ARRAY_MAC(PACKET)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_buffLenArr = {
     "buffLenArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_PACKET_PTR_ARRAY_buffList = {
     "buffList", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_ARRAY_MAC(PACKET)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_buffLenList = {
     "buffLenList", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_PACKET_PTR_ARRAY_packetBuffsArrPtr = {
     "packetBuffsArrPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_ARRAY_MAC(PACKET)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_buffLenArr = {
     "buffLenArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_PACKET_PTR_packetDataPtr = {
     "packetDataPtr", PRV_CPSS_LOG_PARAM_IN_E,  prvCpssLogParamFunc_PACKET_PTR
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_DSA_PTR_dsaBytesPtr = {
     "dsaBytesPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(DSA)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_DSA_PTR_dsaBytesPtr = {
     "dsaBytesPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(DSA)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfRxBufFreeWithSize_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U8_rxQueue,
    &DX_IN_GT_PACKET_PTR_ARRAY_rxBuffList,
    &DX_IN_GT_U32_ARRAY_rxBuffSizeList,
    &DX_IN_GT_U32_buffListLen
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfMiiRxBufFree_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U8_rxQueue,
    &DX_IN_GT_U8_PTR_ARRAY_rxBuffList,
    &DX_IN_GT_U32_buffListLen
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfMiiRxPacketGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U8_queueIdx,
    &DX_INOUT_GT_U32_PTR_numOfBuffPtr,
    &DX_OUT_PACKET_PTR_ARRAY_packetBuffsArrPtr,
    &DX_OUT_GT_U32_ARRAY_buffLenArr,
    &DX_OUT_CPSS_DXCH_NET_RX_PARAMS_STC_PTR_rxParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfSdmaRxPacketGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U8_queueIdx,
    &DX_INOUT_GT_U32_PTR_numOfBuffPtr,
    &DX_OUT_PACKET_PTR_ARRAY_packetBuffsArrPtr,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfSdmaTxPacketSend_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_pcktParamsPtr,
    &DX_IN_PACKET_PTR_ARRAY_buffList,
    &DX_IN_GT_U32_ARRAY_buffLenList,
    &DX_IN_GT_U32_numOfBufs
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfSdmaSyncTxPacketSend_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_pcktParamsPtr,
    &DX_IN_PACKET_PTR_ARRAY_buffList,
    &DX_IN_GT_U32_ARRAY_buffLenList,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfMiiTxPacketSend_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_pcktParamsPtr,
    &DX_IN_PACKET_PTR_ARRAY_packetBuffsArrPtr,
    &DX_IN_GT_U32_ARRAY_buffLenArr,
    &DX_IN_GT_U32_numOfBufs
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfMiiSyncTxPacketSend_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_pcktParamsPtr,
    &DX_IN_PACKET_PTR_ARRAY_packetBuffsArrPtr,
    &DX_IN_GT_U32_ARRAY_buffLenArr,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfSdmaTxGeneratorPacketAdd_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_CPSS_DXCH_NET_TX_PARAMS_STC_PTR_packetParamsPtr,
    &DX_IN_PACKET_PTR_packetDataPtr,
    &DX_IN_GT_U32_packetDataLength,
    &DX_OUT_GT_U32_PTR_packetIdPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfSdmaTxGeneratorPacketUpdate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfDsaTagBuild_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_NET_DSA_PARAMS_STC_PTR_dsaInfoPtr,
    &DX_OUT_DSA_PTR_dsaBytesPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfDsaTagParse_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_DSA_PTR_dsaBytesPtr,
    &DX_OUT_CPSS_DXCH_NET_DSA_PARAMS_STC_PTR_dsaInfoPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfRxBufFree_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U8_rxQueue,
    &DX_IN_GT_U8_PTR_ARRAY_rxBuffList,
    &DX_IN_GT_U32_buffListLen
