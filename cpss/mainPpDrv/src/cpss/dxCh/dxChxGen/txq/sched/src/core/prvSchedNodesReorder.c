                    ...
                    uint16_t node2_index)
{
    ...
    {
        case SCHED_A_LEVEL:
            SWITCH_NODES_PROC(SCHED_A_LEVEL, a_node, queue, TM_CONF_A_NODE_IND_OOR, TM_HW_A_NODE_CONFIG_FAIL)
            break;
        case SCHED_B_LEVEL:
            SWITCH_NODES_PROC(SCHED_B_LEVEL, b_node, a_node, TM_CONF_B_NODE_IND_OOR, TM_HW_B_NODE_CONFIG_FAIL)
            break;
        case SCHED_C_LEVEL:
            SWITCH_NODES_PROC(SCHED_C_LEVEL, c_node, b_node, TM_CONF_C_NODE_IND_OOR, TM_HW_B_NODE_CONFIG_FAIL)
            break;
        case SCHED_P_LEVEL:
            SWITCH_NODES_PROC(SCHED_P_LEVEL, port, c_node, TM_CONF_PORT_IND_OOR, TM_HW_PORT_CONFIG_FAIL)
            break;
        default:
            rc= -ERANGE;
    }
