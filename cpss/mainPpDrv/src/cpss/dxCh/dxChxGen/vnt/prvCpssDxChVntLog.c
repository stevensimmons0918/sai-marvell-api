...
const char * const prvCpssLogEnum_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT[]  =
{
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_mode = {
     "mode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_PTR_modePtr = {
     "modePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_timeStampValuePtr = {
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntCfmReplyModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_mode
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntPortGroupLastReadTimeStampGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_OUT_GT_U32_PTR_timeStampValuePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntCfmLbrOpcodeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_opcode
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntCfmReplyModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_PTR_modePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntCfmLbrOpcodeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_opcodePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVntLastReadTimeStampGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_timeStampValuePtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChVntLogLibDb[] = {
    {"cpssDxChVntOamPortLoopBackModeEnableSet", 3, prvCpssLogGenDevNumPortNumEnable2_PARAMS, NULL},
    {"cpssDxChVntOamPortLoopBackModeEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr2_PARAMS, NULL},
    ...
    {"cpssDxChVntOamPortPduTrapEnableSet", 3, prvCpssLogGenDevNumPortNumEnable2_PARAMS, NULL},
    {"cpssDxChVntOamPortPduTrapEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr2_PARAMS, NULL},
};

/******** DB Access Function ********/
void prvCpssLogParamLibDbGet_DX_CPSS_LOG_LIB_VNT(
