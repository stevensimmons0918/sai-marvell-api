...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_ARRAY_devListArr = {
     "devListArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U8)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChVirtualTcamManagerDevListAdd_PARAMS[] =  {
    &DX_IN_GT_U32_vTcamMngId,
    &DX_IN_GT_U8_ARRAY_devListArr,
...
)
{
    ...
    else
    {
        ...
        PRV_CPSS_LOG_STC_STC_PTR_MAC((&(&valPtr->action)->tti), actionPtr, CPSS_DXCH_TTI_ACTION_STC);
        prvCpssLogStcLogEnd(contextLib, logType);
    }
    prvCpssLogStcLogEnd(contextLib, logType);
    prvCpssLogStcLogEnd(contextLib, logType);
...
)
{
    ...
    else
    {
        ...
        PRV_CPSS_LOG_STC_STC_PTR_MAC((&(&valPtr->rule)->tti), actionPtr, CPSS_DXCH_TTI_ACTION_STC);
        prvCpssLogStcLogEnd(contextLib, logType);
    }
    prvCpssLogStcLogEnd(contextLib, logType);
    prvCpssLogStcLogEnd(contextLib, logType);
