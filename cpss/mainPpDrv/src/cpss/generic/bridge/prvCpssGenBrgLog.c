...
const char * const prvCpssLogEnum_CPSS_BRG_IPM_MODE_ENT[]  =
{
    "CPSS_BRG_IPM_SGV_E",
    "CPSS_BRG_IPM_GV_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_BRG_IPM_MODE_ENT);
const char * const prvCpssLogEnum_CPSS_BRG_MODE_ENT[]  =
{
    "CPSS_BRG_MODE_802_1Q_E",
    "CPSS_BRG_MODE_802_1D_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_BRG_MODE_ENT);
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_BRG_SECUR_BREACH_EVENTS_ENT[]  =
...
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_MAC_SPOOF_PROTECTION_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_MAC_SA_MOVED_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_MAC_SA_IS_DA_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_SIP_IS_DIP_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_TCP_UDP_SPORT_IS_DPORT_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_TCP_FIN_WITHOUT_ACK_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_TCP_WITHOUT_FULL_HEADER_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_MAC_SA_IS_ZERO_E)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_BRG_SECUR_BREACH_EVENTS_ENT);
const char * const prvCpssLogEnum_CPSS_BRG_SRC_ID_ASSIGN_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_BRG_TPID_SIZE_TYPE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_BRIDGE_INGR_CNTR_MODES_ENT[]  =
{
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_ETHER_MODE_ENT[]  =
...
const char * const prvCpssLogEnum_CPSS_FDB_ACTION_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_IGMP_SNOOP_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_MAC_ACTION_MODE_ENT[]  =
{
    "CPSS_ACT_AUTO_E",
    "CPSS_ACT_TRIG_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_MAC_ACTION_MODE_ENT);
const char * const prvCpssLogEnum_CPSS_MAC_HASH_FUNC_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_MAC_SECURE_AUTO_LEARN_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_MAC_TABLE_CMD_ENT[]  =
{
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_MAC_VL_ENT[]  =
...
const char * const prvCpssLogEnum_CPSS_PORT_ACCEPT_FRAME_TYPE_ENT[]  =
{
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_PORT_LOCK_CMD_ENT[]  =
...
const char * const prvCpssLogEnum_CPSS_STP_STATE_ENT[]  =
{
    "CPSS_STP_DISABLED_E",
...
const char * const prvCpssLogEnum_CPSS_VLAN_TAG_TYPE_ENT[]  =
{
    "CPSS_VLAN_TAG0_E",
    "CPSS_VLAN_TAG1_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_VLAN_TAG_TYPE_ENT);
const char * const prvCpssLogEnum_CPSS_BRG_SECUR_BREACH_DROP_COUNT_MODE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_MAC_ENTRY_EXT_TYPE_ENT[]  =
{
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_RATE_LIMIT_MODE_ENT[]  =
...
const char * const prvCpssLogEnum_CPSS_UPD_MSG_TYPE_ENT[]  =
{
    "CPSS_NA_E",
    "CPSS_QA_E",
    "CPSS_QR_E",
...
const char * const prvCpssLogEnum_CPSS_FDB_UC_ROUTING_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_FDB_UC_ROUTING_TYPE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, epgNumber);
...
)
{
    ...
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, routingType, CPSS_FDB_UC_ROUTING_TYPE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, multipathPointer);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, nextHopMcPointer);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_UNT_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_MAC_ENTRY_EXT_KEY_UNT *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, macVlan, CPSS_MAC_ENTRY_EXT_KEY_MAC_VLAN_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ipMcast, CPSS_MAC_ENTRY_EXT_KEY_IP_MCAST_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ipv4Unicast, CPSS_MAC_ENTRY_EXT_KEY_IPV4_UNICAST_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ipv6Unicast, CPSS_MAC_ENTRY_EXT_KEY_IPV6_UNICAST_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_IPV4_UNICAST_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_MAC_ENTRY_EXT_KEY_IPV4_UNICAST_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, dip, 4, GT_U8);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, vrfId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_IPV6_UNICAST_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_MAC_ENTRY_EXT_KEY_IPV6_UNICAST_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, dip, 16, GT_U8);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, vrfId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_IP_MCAST_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_MAC_ENTRY_EXT_KEY_IP_MCAST_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, sip, 4, GT_U8);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, dip, 4, GT_U8);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, vlanId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_MAC_ENTRY_EXT_KEY_MAC_VLAN_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_MAC_ENTRY_EXT_KEY_MAC_VLAN_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
...
void prvCpssLogParamFunc_CPSS_MAC_TABLE_CMD_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_MAC_TABLE_CMD_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_MAC_TABLE_CMD_ENT);
}
void prvCpssLogParamFunc_CPSS_MAC_TABLE_CMD_ENT_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
