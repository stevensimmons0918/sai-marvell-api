...
const char * const prvCpssLogEnum_CPSS_NST_AM_PARAM_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_NST_CHECK_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_NST_EGRESS_FRW_FILTER_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_NST_INGRESS_FRW_FILTER_ENT[]  =
{
