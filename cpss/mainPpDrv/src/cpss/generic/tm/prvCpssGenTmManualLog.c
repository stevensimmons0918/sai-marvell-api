...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_quantumArrPtr = {
     "quantumArrPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_ARRAY_priosPtr = {
     "priosPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_BOOL)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_probabilityArr = {
     "probabilityArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmPortSchedulingUpdate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_index,
    &DX_IN_CPSS_TM_ELIG_FUNC_NODE_ENT_eligPrioFuncId,
    &DX_IN_GT_U32_ARRAY_quantumArrPtr,
    &DX_IN_CPSS_TM_SCHD_MODE_ENT_PTR_schdModeArr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmTreeDwrrPrioSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_BOOL_ARRAY_priosPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmDropWredCurveCreate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_cos,
    &DX_IN_GT_U32_ARRAY_probabilityArr,
