...
const GT_U16 accurateCableLenArr1690[][111] = {
    {
        /* Gain Index: 0, Start: 51, Amount: 50 */
    ...
    {
        /* Gain Index: 1, Start: 17, Amount: 84 */
    ...
    {
        /* Gain Index: 2, Start: 15, Amount: 86 */
    ...
    {
        /* Gain Index: 3, Start: 15, Amount: 86 */
...
/**
* @internal internal_cpssVctCableExtendedStatusGet function
* @endinternal
*
...
)
{
    ...
    GT_U32                  portMacNum;     /* MAC number of a port */
    GT_BOOL                 isNotAldrin;    /* device is not Aldrin/AC3x */
    ...
    PRV_CPSS_DXCH_PORT_NUM_CHECK_AND_MAC_NUM_GET_LOCAL_OR_REMOTE_MAC(devNum, port, portMacNum);
    ...
    isNotAldrin = (PRV_CPSS_PP_MAC(devNum)->devFamily != CPSS_PP_FAMILY_DXCH_ALDRIN_E) &&
...
/**
* @internal internal_cpssVctBindFuncObject function
* @endinternal
...
* @param[in] genVctBindFuncPtr     - structure to hold common VCT functions for PP Family needed in CPSS
*/
static GT_STATUS internal_cpssVctBindFuncObject
(
    IN GT_U8                       devNum,
...
)
{
    ...
    CPSS_NULL_PTR_CHECK_MAC(genVctBindFuncPtr);
    PRV_CPSS_PP_MAC(devNum)->phyInfo.genVctBindFunc = *genVctBindFuncPtr;
    return GT_OK;
}
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssVctFuncObjectBind);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, cpssVctFuncObjectBind));

    rc = internal_cpssVctBindFuncObject(devNum, genVctBindFuncPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, cpssVctFuncObjectBind));
...
/**
* @internal internal_cpssVctCableStatusGet function
* @endinternal
*
...
)
{
    ...
    GT_BOOL      autoNegStatus;     /* PP to PHY Auto - Negotiation status*/
    GT_U16       phyIdRegValue;     /* PHY ID register value */
    GT_U32       numOfPorts;        /* Amount of ports stored at vctInfo */
    GT_U32       portMacNum;        /* MAC number of a port */
    GT_BOOL      isNotAldrin;       /* device is not Aldrin/AC3x */
    ...
    /* check port and device number validity */
    PRV_CPSS_DXCH_PORT_NUM_CHECK_AND_MAC_NUM_GET_LOCAL_OR_REMOTE_MAC(dev, port, portMacNum);
    ...
    if (vctInfo == NULL)
    {
        if(PRV_CPSS_DXCH_PP_HW_INFO_PORT_MAP_CHECK_SUPPORTED_MAC(dev))
        {
            numOfPorts = PRV_CPSS_DXCH_MAX_PHY_PORT_NUMBER_MAC(dev);
        }
        else
        {
            numOfPorts = PRV_CPSS_PP_MAC(dev)->numOfPorts;
        }
    ...
    isNotAldrin = (PRV_CPSS_PP_MAC(dev)->devFamily != CPSS_PP_FAMILY_DXCH_ALDRIN_E) &&
                  (PRV_CPSS_PP_MAC(dev)->devFamily != CPSS_PP_FAMILY_DXCH_AC3X_E);
...
/**
* @internal prvSetTdrWorkAround function
* @endinternal
*
* @brief   Configures TDR test workaround on specified port/device.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal prvPhySoftReset function
* @endinternal
*
* @brief   Reset specified port.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
)
{
    ...
    do
    {
        ...
        PRV_CPSS_MAX_NUM_ITERATIONS_CHECK_CNS(dev,(retryCount++));
...
/**
* @internal prvEnableTdrFe1WorkAround function
* @endinternal
*
* @brief   Enable 1st work around for FE PHYs before enabling TDR test
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
* @retval GT_HW_ERROR              - on hardware error
*
* @note Works on 10/100 FE interfaces.
*
*/
...
/**
* @internal prvDisableTdrFe1WorkAround function
* @endinternal
*
* @brief   Disable 1st work around for FE PHYs after TDR test end
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal prvEnableTdrFe2WorkAround function
* @endinternal
*
* @brief   Enable 2nd work around for FE PHYs before enabling TDR test
...
/**
* @internal prvDisableTdrFe2WorkAround function
* @endinternal
*
* @brief   Disable 2nd work around for FE PHYs after TDR test end
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal prvEnableTdrGeWorkAround function
* @endinternal
*
* @brief   Enable work around for GE PHYs before enabling TDR test
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal prvDisableTdrGeWorkAround function
* @endinternal
*
* @brief   Disable work around for GE PHYs after TDR test end
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal prvGetErrGeCabLen function
* @endinternal
*
* @brief   Convert hw value of GE PHY cabel fault distance to length in meter.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] dev                      - physical device number
* @param[in] port                     - physical  number
* @param[in] dist                     - hw value of cabel fault distance
*
* @param[out] lengthPtr                - error cable length in meter
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
*
* @note y = 0.8081x - 28.751
*
*/
...
/**
* @internal prvGetErrGeCabLenNG function
* @endinternal
*
* @brief   Convert hw value of GE PHY cabel fault distance to length in meters.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
* @param[in] port                     - physical  number
* @param[in] dist                     - hw value of cabel fault distance
* @param[in] phyIdRegValue            - PHY ID register's value
*
* @param[out] lengthPtr                - error cable length in meter
*                                       None
*
* @note Calculation formula : y = 0.8049X - 23 + PHY_type_specific_offset
...
)
{
    ...
    case PRV_CPSS_DEV_E1149R:
        ...
        break;
    case PRV_CPSS_DEV_E1680M: /* PHYs 88E1680M & 88E1680L have the same device version 0x2E */
    case PRV_CPSS_DEV_E1680:
    case PRV_CPSS_DEV_E1543:
    case PRV_CPSS_DEV_E1514:
        mm = (8049 * dist + offset)/10000;
        break;
    case PRV_CPSS_DEV_E1690:
        /* Read current page */
        PRV_PHY_REG_READ_MAC(dev, port, 22, &page);
        /* select page 5 */
        PRV_PHY_REG_WRITE_MAC(dev, port, 22, 0x5);

        /* Read current pulse width value */
        PRV_PHY_REG_READ_MAC(dev, port, 28, &data);

        /* get relevant bits, FULL PULSE (0) */
        data &= (0x3 << 10);
        ...
        if (data == 0)
        {
            /* FULL PULSE (0) - Formula for long cable */
            mm = (((8333 * dist) - 191667) + (10*offset) + 5000) / 10000;
        }
        else
        {
            /* 1/4 PULSE - Formula for short length cable */
            mm = ((8049 * dist) + (10*offset))/10000;
        }
        break;
...
/**
* @internal prvGetErrFeCabLen function
* @endinternal
*
* @brief   Convert hw value of FE PHY cabel fault distance to length in meter.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
*
* @param[out] phyTypePtr               - (pointer to) PHY type, may be NULL
* @param[out] phyIdRegValuePtr         - (pointer to) PHY ID register value
*
...
/**
* @internal prvGetExtendedCableStatus_Phy100M function
* @endinternal
*
* @brief   This routine perform the extended virtual cable test for the 10/100Mbps
...
*
* @param[out] extendedCableStatusPtr   - the port extended vct cable status.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/
...
/**
* @internal prvGetExtendedCableStatus_Phy1000M function
* @endinternal
*
* @brief   This routine perform the extended virtual cable test for the 1000Mbps
*         phy, and returns the status.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
...
/**
* @internal prvGetExtendedCableStatus_Phy1000MMP_NG function
* @endinternal
*
* @brief   This routine perform the extended virtual cable test for the 1000Mbps
...
* @param[in] dev                      - device number
* @param[in] port                     - logical  number.
* @param[in] phyIdRegValue            - value of PHY ID register
*
* @param[out] extendedCableStatusPtr   - the port extended vct cable status.
*
* @retval GT_OK                    - on success
...
)
{
    ...
    GT_U32      offset = 0;
    GT_U32      startEntry = 0;
    const GT_U16    *accurateLengthArr;        /* accurate length coversion table */
   ...
   /* get registers addresses and control value */
    ...
    for(j = 0; j < CPSS_VCT_MDI_PAIR_NUM_CNS; j++)
    {
        ...
        case PRV_CPSS_DEV_E1690:
            ...
            accurateLengthArr = &accurateCableLenArr1680LRevA0[0][0];
            i = 0xFFFF; /* to prevent VC10: "warning C4701: potentially
                            uninitialized local variable 'i' used" later  */

            /* phy 1680L Rev A0 (PHYs 1680M & 1680L have the same device version) or phy 1680 */
            if ((((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1680M) && ((phyIdRegValue & PRV_CPSS_PHY_REV_MASK) >= 0x1)) ||
                ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1680))
            {
                ...
                case 1:
                    ...
                    maxValue = 130;
                    i = 1;
                    accurateLengthArr = &accurateCableLenArr1680LRevA0[1][0];
                    break;
                case 2:
                    offset = 69;
                    maxValue = 130;
                    i = 2;
                    accurateLengthArr = &accurateCableLenArr1680LRevA0[2][0];
                    break;
                default: /* no change */
            ...
            if (((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1690))
            {
                /* values for gain 0-2 from 1680L gain-based DSP VCT Table doc */
                switch(value & 0x7) {
                case 0:
                    ...
                    maxValue = 53;
                    i = 0;
                    accurateLengthArr = &accurateCableLenArr1690[0][0];
                    break;
                case 1:
                    startEntry = 17;
                    offset = 84;
                    maxValue = 143;
                    i = 1;
                    accurateLengthArr = &accurateCableLenArr1690[1][0];
                    break;
                case 2:
                    startEntry = 15;
                    offset = 86;
                    maxValue = 156;
                    i = 2;
                    accurateLengthArr = &accurateCableLenArr1690[2][0];
                    break;
                case 3:
                    startEntry = 15;
                    offset = 86;
                    maxValue = 169;
                    i = 3;
                    accurateLengthArr = &accurateCableLenArr1690[3][0];
                    break;
                default: /* no change */
                    extendedCableStatusPtr->accurateCableLen.isValid[j] = GT_FALSE;
                    DBG_VCT_MAC(("\n isValid = FALSE"));
            ...
            if (extendedCableStatusPtr->accurateCableLen.isValid[j] == GT_TRUE) {
                if ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1543){
                    /* phy 1540 uses the same lookup table as phy 1340 */
                    if(lengthSum > 88)
                    {
                        extendedCableStatusPtr->accurateCableLen.cableLen[j] = 130;
                    }
                ...
                else if (lengthSum < startEntry) {
                    DBG_VCT_MAC(("\n startEntry=%d, maxValue=%d", startEntry, maxValue));
                    extendedCableStatusPtr->accurateCableLen.cableLen[j] = accurateLengthArr[0];
                    DBG_VCT_MAC(("\n cable length set by max value to %d meter", extendedCableStatusPtr->accurateCableLen.cableLen[j]));
                }
                else if (lengthSum > (offset + startEntry - 1)) {
                    DBG_VCT_MAC(("\n offset=%d, maxValue=%d", offset, maxValue));
                    extendedCableStatusPtr->accurateCableLen.cableLen[j] = maxValue;
                    DBG_VCT_MAC(("\n cable length set by max value to %d meter", extendedCableStatusPtr->accurateCableLen.cableLen[j]));
                }
                else if ((((phyIdRegValue & PRV_CPSS_PHY_REV_MASK) >= 0x1) && (i != 0xFFFF)) ||
                     ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1680) ||
                     ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1690))
                {
                    DBG_VCT_MAC(("\n A0. length =%d meters,  table exchange on phy 1680L rev A0, cableLen = %d", lengthSum, accurateLengthArr[lengthSum-startEntry]));
                    extendedCableStatusPtr->accurateCableLen.cableLen[j] = accurateLengthArr[lengthSum-startEntry];
...
/**
* @internal prvGetExtendedCableStatus_Phy1000MMP function
* @endinternal
*
* @brief   This routine perform the extended virtual cable test for the 1000Mbps
...
/**
* @internal prvVctReady_Phy100M function
* @endinternal
*
* @brief   This routine asserts the first state of virtual cable test for the
*         10/100Mbps phy.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
...
/**
* @internal prvVctReady_Phy1000M function
* @endinternal
*
* @brief   This routine asserts the first state of virtual cable test for the
*         1000Mbps phy.
...
/**
* @internal prvVctStarted_Phy100M function
* @endinternal
*
* @brief   This routine asserts the second state of virtual cable test for the
...
* @param[in] dev                      - device number.
* @param[in] port                     - logical  number.
* @param[in] action                   - to be used by both CPSS_VCT_STARTED_E and
*                                      CPSS_VCT_REDO_PHASE_1_E
*
* @param[out] cableStatusPtr           - the port copper cable status.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/
...
/**
* @internal prvVctRedoPhase2_Phy100M function
* @endinternal
*
* @brief   This routine asserts the Phase2 state of virtual cable test for the
*         10/100Mbps phy. If succeded, it returns the returns the the status per
*         Rx/Tx pair. Otherwise, it restarts the test.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
...
/**
* @internal prvVctStarted_Phy1000M function
* @endinternal
*
* @brief   This routine asserts the second state of virtual cable test for the
...
/**
* @internal prvVctReady_Phy1000MMP function
* @endinternal
*
* @brief   This routine asserts the first state of virtual cable test for the
...
/**
* @internal prvVctReady_Phy1000MMP_NG function
* @endinternal
*
* @brief   This routine asserts the first state of virtual cable test for the
...
/**
* @internal prvVctStarted_Phy1000MMP function
* @endinternal
*
* @brief   This routine asserts the second state of virtual cable test for the
...
/**
* @internal prvVctStarted_Phy1000MMP_NG function
* @endinternal
*
* @brief   This routine asserts the second state of virtual cable test for the
            ...
            for (rxPair = 0; rxPair < CPSS_VCT_MDI_PAIR_NUM_CNS; rxPair++)
            {
                ...
                else
                {
                    ...
                    if( ( ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1543) ||
                          ...
                          ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1514) ||
                          ((phyIdRegValue & PRV_CPSS_PHY_MODEL_MASK) == PRV_CPSS_DEV_E1690))&&
...
/**
* @internal gtPrvSetTxPulseTwistedPair function
* @endinternal
*
* @brief   Sets the pair to launch the pulse.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
* @param[in] twistedPairNum           - one out of four cable pairs(values 0-3)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_NOT_SUPPORTED         - on not supported PHYs
*/
static GT_STATUS gtPrvSetTxPulseTwistedPair
(
    IN  GT_U8     dev,
...
/**
* @internal internal_cpssVctSetCableDiagConfig function
* @endinternal
*
...
/**
* @internal internal_cpssVctLengthOffsetSet function
* @endinternal
*
...
)
{
    ...
    portMacObjPtr = PRV_CPSS_PHY_MAC_OBJ(dev,portMacNum);

    /* run MACPHY callback */
    if (portMacObjPtr != NULL && portMacObjPtr->macDrvMacVctLengthOffsetSetFunc)
    {
        GT_BOOL doPpMacConfig = GT_TRUE;

        rc = portMacObjPtr->macDrvMacVctLengthOffsetSetFunc(dev,port,
                                  offset,CPSS_MACDRV_STAGE_PRE_E,
                                  &doPpMacConfig);
        if(rc != GT_OK)
        {
            return rc;
...
/**
* @internal internal_cpssVctLengthOffsetGet function
* @endinternal
*
...
)
{
    ...
    /* run MACPHY callback */
    if (portMacObjPtr != NULL && portMacObjPtr->macDrvMacVctLengthOffsetGetFunc)
    {
        GT_BOOL doPpMacConfig = GT_TRUE;

        rc = portMacObjPtr->macDrvMacVctLengthOffsetGetFunc(dev,port,
                                  offsetPtr,CPSS_MACDRV_STAGE_PRE_E,
                                  &doPpMacConfig);
        if(rc != GT_OK)
        {
            return rc;
