...
#include <cpss/generic/diag/private/serdesOpt/SerdesRxOptDeviceIf.h>
...
/**
* @internal genCompareNodes function
* @endinternal
*
* @brief   Compares two id generator structs data, and returns one of the following
*         results: GT_SL_EQUAL / GT_SL_SMALLER / GT_SL_GREATER.
* @param[in] data1                    - A pointer to the first struct to be compared.
* @param[in] data2                    - A pointer to the second struct to be compared.
*                                       GT_SL_EQUAL / GT_SL_SMALLER / GT_SL_GREATER.
*
* @note For full declaration of the compare function see:
*       common/gtSkipList.h
*
*/
...
/**
* @internal mvSerdesTunningSystemInit function
* @endinternal
*
* @brief   Init environment variables for tunning algorithm.
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
...
)
{
    ...
    /* This code must be protected to prevent 2 threads from accessing
       rxLanes and txLanes on the same time */
...
/**
* @internal mvSerdesTunningSystemClose function
* @endinternal
*
* @brief   Free all resources allocated by tunning algorithm.
*/
...
/**
* @internal mvSerdesTunningRxLaneRegister function
* @endinternal
*
* @brief   Configure all RX lane related information for tunning
*         (include access functions pointers).
* @param[in] devNum                   - Device Number
* @param[in] portGroup                - port group (core) number
* @param[in] laneNum                  - Lane Number.
* @param[in] prbsType                 - PRBS type (7, 15, 23, 31).
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
...
/**
* @internal mvSerdesTunningRxLaneUnregister function
* @endinternal
*
* @brief   Remove RX lane related information from tunning algorithm
*
* @param[in] devNum                   - Device Number
* @param[in] portGroup                - port group (core) number
* @param[in] laneNum                  - Lane Number.
...
/**
* @internal mvSerdesTunningTxLaneRegister function
* @endinternal
*
* @brief   Configure all TX lane related information to run PRBS
...
/**
* @internal mvSerdesTunningTxLaneUnregister function
* @endinternal
*
* @brief   Remove TX lane related information from tunning algorithm
*
* @param[in] devNum                   - Device Number
* @param[in] portGroup                - port group (core) number
* @param[in] laneNum                  - Lane Number.
...
/**
* @internal mvSerdesTunningStartTx function
* @endinternal
*
* @brief   Run PRBS on TX lanes configured.
*/
void mvSerdesTunningStartTx(GT_VOID)
{
    GT_UINTPTR iter;
    MV_LANE_DATA *slNode;
...
/**
* @internal mvSerdesTunningStopTx function
* @endinternal
*
* @brief   Stop PRBS transmit on TX lanes registered.
*/
void mvSerdesTunningStopTx(GT_VOID)
{
...
/**
* @internal mvSerdesTunningStart function
* @endinternal
*
* @brief   Run serdes parameters tunning algorithm (on all RX lanes).
*
* @param[in] prbsTime                 - duration of the PRBS test during suggested setup verification [ms].
* @param[in] testMode                 - run different algorithm variations
*
* @retval 0                        - tunning success on all RX lanes
* @retval 1                        - tunning failed
*/
...
/**
* @internal mvSerdesTunningReport function
* @endinternal
*
* @brief   Return serdes optimal parameters.
*
* @param[in] devNum                   - Device Number
* @param[in] portGroup                - port group (core) number
* @param[in] laneNum                  - Lane Number.
...
/**
* @internal mvSerdesTunningReportTypeSet function
* @endinternal
*
