...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PROTECTION_LOC_STATUS_ENT_status;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_locTableIndex;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PROTECTION_LOC_STATUS_ENT_PTR_statusPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_locTableIndexPtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChProtectionEnableSet_E = (CPSS_LOG_LIB_PROTECTION_E << 16) | (1 << 24),
