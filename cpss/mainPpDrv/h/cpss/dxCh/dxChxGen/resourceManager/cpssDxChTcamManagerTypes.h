...
/**
********************************************************************************
* @file cpssDxChTcamManagerTypes.h
*
* @brief This file contains types for TCAM manager object.
*
* @version   5
********************************************************************************
*/
 ...
 *
 * @brief Holds representation of TCAM location.
*/
typedef struct{
 ...
 *
 * @brief Entry types that can be allocated by the TCAM manager.
*/
typedef enum{
    ...
    /** dual entry aligned to even column */
    CPSS_DXCH_TCAM_MANAGER_DUAL_ENTRY_E         = 1,

    /** triple entry aligned to row start */
    CPSS_DXCH_TCAM_MANAGER_TRIPLE_ENTRY_E       = 2,

    /** quad entry aligned to row start */
 ...
 *
 * @brief TCAM location allocation method.
*/
typedef enum{

    /** @brief allocate location as close as possible
     *  to the lower boundary
     */
    CPSS_DXCH_TCAM_MANAGER_ALLOC_MIN_E      = 0,

    /** @brief allocate location near the middle
 ...
 *
 * @brief Type of data dump.
*/
typedef enum{

    /** @brief dump the list of clients currently registered to
     *  the TCAM manager
     */
    CPSS_DXCH_TCAM_MANAGER_DUMP_CLIENTS_E                               = 0,

    /** @brief dump list of entries allocated for a specific client
     *  in the TCAM manager
     */
    CPSS_DXCH_TCAM_MANAGER_DUMP_ENTRIES_FOR_SPECIFIC_CLIENT_E           = 1,

    /** @brief dump list of entries allocated for all clients that
     *  are currently registered in the TCAM manager
     */
    CPSS_DXCH_TCAM_MANAGER_DUMP_ENTRIES_FOR_ALL_CLIENTS_E               = 2,

    /** @brief dump the list of clients surrently registered and also
