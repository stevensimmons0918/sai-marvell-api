...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_CELL_COUNTER_TYPE_ENT_cellType;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_DESCRIPTOR_TYPE_ENT_type;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_DIRECTION_ENT_cellDirection;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_ECC_TYPE_ENT_eccType;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_FC_RX_E2E_HEADER_STC_PTR_e2eParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_FC_RX_LINK_LAYER_PARAMS_STC_PTR_llParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_FABRIC_HGL_RX_DSA_STC_PTR_dsaParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_idleCntEnable;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_maxIdleCnt;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_CELL_COUNTER_TYPE_ENT_PTR_cellTypePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_DESCRIPTOR_TYPE_ENT_PTR_typePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_ECC_TYPE_ENT_PTR_eccTypePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_FC_RX_E2E_HEADER_STC_PTR_e2eParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_FC_RX_LINK_LAYER_PARAMS_STC_PTR_llParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_RX_DSA_STC_PTR_dsaParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FABRIC_HGL_RX_ERROR_CNTRS_STC_PTR_rxErrorsCntrsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_idleCntEnablePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_laneSyncOkArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_cellCntrPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_maxIdleCntPtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChFabricHGLinkPcsLoopbackEnableSet_E = (CPSS_LOG_LIB_FABRIC_E << 16) | (1 << 24),
