...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_L2MLL_COUNTER_SET_INTERFACE_CFG_STC_PTR_interfaceCfgPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_L2_MLL_LTT_ENTRY_STC_PTR_lttEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_L2_MLL_MULTI_TARGET_PORT_RANGE_STC_PTR_portRangeConfigPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_L2_MLL_PAIR_STC_PTR_mllPairEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_trapEnable;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_maxVidxIndex;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_mllPointer;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_portBase;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_vidxBase;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_targetDevNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_targetPortNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_L2MLL_COUNTER_SET_INTERFACE_CFG_STC_PTR_interfaceCfgPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_L2_MLL_EXCEPTION_COUNTERS_STC_PTR_countersPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_L2_MLL_LTT_ENTRY_STC_PTR_lttEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_L2_MLL_MULTI_TARGET_PORT_RANGE_STC_PTR_portRangeConfigPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_L2_MLL_PAIR_STC_PTR_mllPairEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_trapEnablePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_maxVidxIndexPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_mllPointer;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_portBasePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_vidxBasePtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChL2MllLookupForAllEvidxEnableSet_E = (CPSS_LOG_LIB_L2_MLL_E << 16) | (1 << 24),
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChL2MllMultiTargetPortRangeSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChL2MllMultiTargetPortRangeGet_E,
