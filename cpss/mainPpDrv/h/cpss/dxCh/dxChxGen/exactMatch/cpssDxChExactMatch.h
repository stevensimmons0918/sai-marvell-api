...
typedef enum{
    ...
    /** EXACT MATCH client tunnel termination (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman) */
    ...
    /** EXACT MATCH client ingress policy 1 (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman) */
    CPSS_DXCH_EXACT_MATCH_CLIENT_IPCL_1_E,

    /** EXACT MATCH client ingress policy 2 (APPLICABLE DEVICES: AC5P; AC5X; Harrier; Ironman) */
    CPSS_DXCH_EXACT_MATCH_CLIENT_IPCL_2_E,

    /** EXACT MATCH client egress policy (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman) */
