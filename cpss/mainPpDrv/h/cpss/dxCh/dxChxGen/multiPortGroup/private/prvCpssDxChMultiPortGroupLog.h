...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_FDB_MODE_ENT_fdbMode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_LOOKUP_NOT_FOUND_STC_PTR_infoPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_RING_INFO_STC_PTR_ringInfoArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_SRC_HASH_MODE_ENT_mode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MULTI_PORT_GROUP_SRC_PORT_HASH_PAIR_STC_PTR_portsArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_PORT_NUM_PTR_uplinkPortsArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_numOfPorts;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_numOfUplinkPorts;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ringInfoNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_sourcePortGroupId;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_MULTI_PORT_GROUP_FDB_MODE_ENT_PTR_fdbModePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_MULTI_PORT_GROUP_LOOKUP_NOT_FOUND_STC_PTR_infoPtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChMultiPortGroupConfigSet_E = (CPSS_LOG_LIB_MULTI_PORT_GROUP_E << 16) | (1 << 24),
