...
/**
********************************************************************************
* @file prvCpssDxChLpmTcamCommonTypes.h
*
* @brief Private cpss DXCH LPM library type definitions
*
* @version   1
********************************************************************************
*/
...
/**
* @enum PRV_CPSS_DXCH_LPM_TCAM_HSU_STAGE_ENT
 *
 * @brief A enum representing an LPM shadow iterartor stage
*/
typedef enum{
...
/**
* @enum PRV_CPSS_DXCH_LPM_TCAM_UPDATE_TYPE_ENT
 *
 * @brief A enum representing an LPM tries update mode
*/
typedef enum{
    ...
    /** overwrite the whole MC UC Tries */
...
/**
* @enum PRV_CPSS_DXCH_LPM_TCAM_IP_MC_ENTRY_TYPE_ENT
 *
 * @brief This enum represents mc entry types
*/
typedef enum{
    ...
    /** mc entry that consists of group and source */
