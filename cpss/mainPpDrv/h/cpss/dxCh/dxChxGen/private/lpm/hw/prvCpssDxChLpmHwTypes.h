...
/**
********************************************************************************
* @file prvCpssDxChLpmHwTypes.h
*
* @brief HW memory read/write internal definitions
*
* @version   1
********************************************************************************
*/
...
/**
* @enum PRV_CPSS_DXCH_LPM_CNT_SET_ENT
 *
 * @brief Each next hop can be linked with one the below counter sets.
*/
typedef enum{
...
/**
* @enum PRV_CPSS_DXCH_LPM_CPU_CODE_INDEX_ENT
 *
 * @brief this value is added to the CPU code assignment in case of trap
 * or mirror
*/
typedef enum{
