...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_LOGICAL_TARGET_MAPPING_EGRESS_VLAN_MEMBER_ACCESS_MODE_ENT_mode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC_PTR_logicalPortMappingTablePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_vlanIdIndex;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_logicalDevNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_logicalPortNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_LOGICAL_TARGET_MAPPING_EGRESS_VLAN_MEMBER_ACCESS_MODE_ENT_PTR_modePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC_PTR_logicalPortMappingTablePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_vlanIdIndexPtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChLogicalTargetMappingEnableSet_E = (CPSS_LOG_LIB_LOGICAL_TARGET_E << 16) | (1 << 24),
