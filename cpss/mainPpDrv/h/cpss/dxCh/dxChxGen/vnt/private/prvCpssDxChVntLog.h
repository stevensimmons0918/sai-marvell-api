...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_mode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_VNT_CFM_REPLY_MODE_ENT_PTR_modePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_timeStampValuePtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDxChVntOamPortLoopBackModeEnableSet_E = (CPSS_LOG_LIB_VNT_E << 16) | (1 << 24),
