...
/* 4 shared pools at SIP6 .
Two POOLS can be used for TAIL DROP and PFC  and two extra can be used for counting */

#define SIP6_SHARED_REGULAR_POOLS_NUM_CNS     2
#define SIP6_SHARED_EXT_POOLS_NUM_CNS 2

#define SIP6_SHARED_TOTAL_POOLS_NUM_CNS (SIP6_SHARED_REGULAR_POOLS_NUM_CNS+SIP6_SHARED_EXT_POOLS_NUM_CNS)
