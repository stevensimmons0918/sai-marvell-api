...
/**
********************************************************************************
* @file prvCpssGenPhySmi.h
*
* @brief Private API implementation for port Core Serial Management Interface facility.
*
* @version   19
********************************************************************************
*/
...
#define PRV_CPSS_DEV_E1514          (0x1D << 4)
...
#define PRV_CPSS_DEV_E1690          (0x00 << 4)
