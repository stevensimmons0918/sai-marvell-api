 ...
 *
 * @brief This enum defines Bridge Source Id Assignment Mode.
*/
typedef enum{

    /** @brief If packet's MAC Source address
    ...
    /** @brief Packet is assigned with the port's
