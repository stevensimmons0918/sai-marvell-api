...
/**
********************************************************************************
* @file prvCpssGenDragonite.h
*
* @brief Private definitions for CPSS DRAGONITE implementation
*
*
* @version   10
********************************************************************************
...
/**
* @struct PRV_CPSS_DRAGONITE_COMM_MSG_STRUCT_VALID_STC
 *
 * @brief structure holds internal info per dragonite structure type
*/
typedef struct
{
...
/**
* @struct PRV_CPSS_DRAGONITE_IRQ_MEMORY_STC
 *
 * @brief irq shared memory structure
*/
typedef struct{

    /** dragonite interrupt cause register */
    GT_U32 irqCause;

    /** dragonite interrupt mask register */
    GT_U32 irqMask;

    /** @brief dragonite interrupt flag bit
     *  Note:
     *  None
     */
    GT_U32 irqFlag;
...
/**
* @enum PRV_CPSS_GEN_DRAGONITE_IRQ_TYPE_ENT
 *
 * @brief This enum defines possible interrupts types - used to define bitmap of
...
typedef enum{
    ...
    /** When any DRAGONITE device stops communicating */
    ...
    /** @brief When power consumption is above power limit (Static or
     *  Dynamic)
     */
...
/**
* @struct PRV_CPSS_DRAGONITE_INTERRUPT_CTRL_STC
 *
 * @brief dragonite interrupt control structure
*/
typedef struct{

    PRV_CPSS_DRV_EV_REQ_NODE_STC *intNodesPool;

    /** @brief Isr function pointer to be called on interrupt reception.
    ...
    /** dragonite interrupt mask */
    GT_UINTPTR intMask;

    /** @brief Id to be used for future access to the connected isr.
     *  Note:
     *  None
     */
...
/**
* @internal dragoniteInterruptsInit function
* @endinternal
*
* @brief   Initialize the DRAGONITE interrupts mechanism
*
* @note   APPLICABLE DEVICES:      xCat; xCat3; AC5.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Puma2; Puma3; ExMx.
*
