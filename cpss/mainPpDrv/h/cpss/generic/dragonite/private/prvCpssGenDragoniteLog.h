...
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_GEN_DRAGONITE_DATA_TYPE_ENT_type;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_HEX_intMask;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_intVectNum;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssDragoniteInit_E = (CPSS_LOG_LIB_DRAGONITE_E << 16) | (1 << 24),
