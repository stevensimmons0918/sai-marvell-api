...
/**
********************************************************************************
* @file SerdesRxOptimizer.h
*
* @brief Serdes optimizer API definition
*
* @version   2
********************************************************************************
*/
...
* @endinternal
*
* @brief   Run PRBS on TX lanes registered in the system.
*/
...
* @endinternal
*
* @brief   Print optimal serdes parameters for tested lane for Verbose report mode.
