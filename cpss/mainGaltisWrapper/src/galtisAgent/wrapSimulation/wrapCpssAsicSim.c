...
/**
* @internal wrIndirectTblMemoryTest function
* @endinternal
*
* @brief   Check proper read/write procedures for tables with indirect access
*
* @retval CMD_OK                   - on success.
* @retval CMD_AGENT_ERROR          - on failure.
*
...
#if 0
/**
* @internal tableCtrlRegInfoGet function
* @endinternal
*
* @brief   Look up in the control register's data array by register address
...
#endif /*0*/
/**
* @internal wrSearchMemoryTest function
* @endinternal
*
* @brief   The goal of the test is to check that all registers and tables
...
/**
* @internal cmdCpssLibInitAsicSim function
* @endinternal
*
