...
* @retval GT_FAIL                  - on error
*
* @note The creation is always for one segment. The pointer to the data is
...
* @endinternal
*
* @brief   Indicates for cmdCpssDxChTxGetPacketDesc function that user go to get many
...
/**
* @internal cmdCpssDxChEmbComTxDelPacketDesc function
* @endinternal
*
* @brief   Delete packet descriptor entry from the table.
*
...
*
*/
GT_STATUS cmdCpssDxChEmbComTxDelPacketDesc
(
    IN  GT_U32      entryId,
    IN CPSS_DXCH_NET_DSA_CMD_ENT  dsaCmd,
    ...
    if(cpssDxChTxPacketDescTbl != NULL)
    {
        ...
        for( j=0; j < MAX_NUM_OF_SDMA_BUFFERS_PER_CHAIN ; j++ )
        {
            ...
            if(txPcktDescPtr->pcktData[j] != NULL)
            {
                ...
                cmdOsPoolFreeBuf(poolId, txPcktDescPtr->pcktData[j]);
            }
        }/*For all buffers for this descriptor*/
...
/**
* @internal cmdCpssDxChEmbComTxClearPacketDesc function
* @endinternal
*
* @brief   Clear all packet descriptors entries from the table.
*
...
*
*/
GT_STATUS cmdCpssDxChEmbComTxClearPacketDesc
(
    IN CPSS_DXCH_NET_DSA_CMD_ENT  dsaCmd,
    IN GT_POOL_ID poolId
)
{
    ...
    numOfFreeBuffers = cmdOsPoolGetBufFreeCnt(poolId);
    cmdOsPrintf("cmdCpssDxChEmbComTxClearPacketDesc  cmd = %d numOfFreeBuffers = %d \n",dsaCmd,numOfFreeBuffers);
