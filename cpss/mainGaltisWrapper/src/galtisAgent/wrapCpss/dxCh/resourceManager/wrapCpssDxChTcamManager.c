...
/**
********************************************************************************
* @file wrapCpssDxChTcamManager.c
*
* @brief Wrapper functions for tcam cpss functions (dxChx).
*
* @version   8
********************************************************************************
*/
...
/**
* @internal prvTcamPrepareTokenArray function
* @endinternal
*
* @brief   Prepare tcam token array (dynamically extended)
*
* @param[in] entryTokenIdx            - index needed to operate
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
* @retval GT_NO_RESOURCE           - if no CPU memory for memory allocation
...
/**
* @internal wrCpssDxChTcamManagerCreate function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerConfigGet function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerDelete function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerRangeUpdate function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerClientRegister function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerClientUnregister function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerEntriesReservationSetFirst function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerEntriesReservationSetNext function
* @endinternal
*
* @brief   Reserves entries for a client in the TCAM manager.
*
...
/**
* @internal wrCpssDxChTcamManagerEntriesReservationEndSet function
* @endinternal
*
* @brief   Reserves entries for a client in the TCAM manager.
*
...
/**
* @internal wrCpssDxChTcamManagerEntriesReservationGetFirst function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerEntriesReservationGetNext function
* @endinternal
*
* @brief   Gets number of reserved entries for a client in the TCAM manager.
*
...
/**
* @internal wrCpssDxChTcamManagerUsageGetFirst function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerUsageGetNext function
* @endinternal
*
* @brief   Returns the current number of entries from each type used by all
*         clients in the TCAM manager.
...
/**
* @internal wrCpssDxChTcamManagerEntryFreeDel function
* @endinternal
*
* @brief   Frees entry.
*
...
/**
* @internal wrCpssDxChTcamManagerEntryFreeClear function
* @endinternal
*
* @brief   Frees entry.
*
...
/**
* @internal wrCpssDxChTcamManagerDump function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerEntryAllocate function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerEntryClientCookieUpdate function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerAvailableEntriesCheckSetFirst function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerAvailableEntriesCheckSetNext function
* @endinternal
*
* @brief   Checks whether the TCAM manager has enough available entries for the
*         requested amount of entries.
...
/**
* @internal wrCpssDxChTcamManagerAvailableEntriesCheckEndSet function
* @endinternal
*
* @brief   Checks whether the TCAM manager has enough available entries for the
*         requested amount of entries.
...
/**
* @internal wrCpssDxChTcamManagerTokenToTcamLocation function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerTokenCompare function
* @endinternal
*
...
/**
* @internal wrCpssDxChTcamManagerGetFromLpmDb function
* @endinternal
*
* @brief   Get the TCAM manager handler used by the LPM DB.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
* @retval GT_BAD_PTR               - on NULL pointer
...
/**
* @internal cmdLibInitCpssDxChTcamManager function
* @endinternal
*
