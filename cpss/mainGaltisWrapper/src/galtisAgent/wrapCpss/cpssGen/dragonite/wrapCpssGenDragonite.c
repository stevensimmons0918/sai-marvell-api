...
/**
********************************************************************************
* @file wrapCpssGenDragonite.c
*
* @brief CPSS wrappers for generic Dragonite APIs.
*
* @version   7
********************************************************************************
*/
...
/**
* @internal wrCpssDragoniteEndSet function
* @endinternal
*
* @brief   Write Dragonite table of any kind
*
* @note   APPLICABLE DEVICES:      DxChXcat and above
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on BSP/HW error
*                                       COMMENT:
*                                       None.
*/
...
/**
* @internal cmdLibInitCpssGenDragonite function
* @endinternal
*
