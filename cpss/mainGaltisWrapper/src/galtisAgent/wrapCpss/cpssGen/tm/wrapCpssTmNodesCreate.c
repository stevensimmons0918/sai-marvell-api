...
/**
********************************************************************************
* @file wrapCpssTmNodesCreate.c
*
* @brief Wrapper functions for TM nodes creation APIs.
*
* @version   1
********************************************************************************
*/
...
/**
* @internal wrCpssTmPortCreate function
* @endinternal
*
...
)
{
    ...
    result = cpssTmPortCreate(devNum, portInd, &params, cNodesNum, bNodesNum, aNodesNum, queuesNum);
...
/**
* @internal wrCpssTmAsymPortCreate function
* @endinternal
*
...
)
{
    ...
    /* call cpss api function */
    result = cpssTmAsymPortCreate(devNum, portInd, &params);
...
/**
* @internal wrCpssTmPortDropPerCosConfig function
* @endinternal
*
...
/**
* @internal wrCpssTmQueueToPortCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmTransQueueToPortCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmQueueToCnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmQueueToBnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmQueueToAnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmQueueToAnodeByIndexCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmAnodeToPortCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmAnodeToCnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmAnodeToBnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmAnodeToBnodeWithQueuePoolCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmBnodeToPortCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmBnodeToCnodeCreate function
* @endinternal
*
...
/**
* @internal wrCpssTmCnodeToPortCreate function
* @endinternal
*
...
/**
* @internal cmdLibInitCpssTmNodesCreate function
* @endinternal
*
