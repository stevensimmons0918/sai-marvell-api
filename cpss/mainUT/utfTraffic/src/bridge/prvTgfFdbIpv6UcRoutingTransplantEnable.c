...
/**
********************************************************************************
* @file prvTgfFdbIpv6UcRoutingTransplantEnable.c
*
* @brief FDB Ipv6 UC Routing + Transplant configurations
*
* @version   1
********************************************************************************
*/
...
static GT_BOOL prvTgfUcIpv6RouteTransplantStatusFirstCall=GT_TRUE;/* is this the first call to save the value */
static GT_BOOL prvTgfUcIpv6RouteTransplantStatusGet;

static CPSS_INTERFACE_INFO_STC  prvTgfUcIpv6RouteTransplantOldInterfaceGet;
static CPSS_INTERFACE_INFO_STC  prvTgfUcIpv6RouteTransplantNewInterfaceGet;
...
)
{
    ...
    oldInterface.devPort.hwDevNum = hwDevNum;
    oldInterface.devPort.portNum = (GT_PORT_NUM)oldPort;

    newInterface.type = CPSS_INTERFACE_PORT_E;
    newInterface.devPort.hwDevNum = hwDevNum;
    newInterface.devPort.portNum = (GT_PORT_NUM)newPort;

    if(prvTgfUcIpv6RouteTransplantStatusFirstCall==GT_TRUE)
    {
        /* save fdb routing uc Transplant data */
        rc =  prvTgfBrgFdbActionTransplantDataGet(prvTgfDevNum,
                                               &prvTgfUcIpv6RouteTransplantOldInterfaceGet,
                                               &prvTgfUcIpv6RouteTransplantNewInterfaceGet);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbActionTransplantDataGet: %d", prvTgfDevNum);

        /* save fdb routing uc Transplant status*/
        rc =  prvTgfBrgFdbRoutingUcTransplantEnableGet(prvTgfDevNum,
                                                       &prvTgfUcIpv6RouteTransplantStatusGet);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbRoutingUcTransplantEnableGet: %d", prvTgfDevNum);
    }

    /* set Transplant Data */
    rc =  prvTgfBrgFdbActionTransplantDataSet(&oldInterface,
                                              &newInterface);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbActionTransplantDataSet: %d", prvTgfDevNum);

    /* set Transplant Enable */
    rc =  prvTgfBrgFdbRoutingUcTransplantEnableSet(prvTgfDevNum,enableFdbRoutingTransplant);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbRoutingUcTransplantEnableSet: %d", prvTgfDevNum);

    PRV_UTF_LOG0_MAC("======= : trigger transplant by HW =======\n");
    /* trigger transplant by HW*/
    rc = prvTgfBrgFdbActionStart(PRV_TGF_FDB_ACTION_TRANSPLANTING_E);
...
)
{
    ...
    for (portIter = 0; portIter < PRV_TGF_PORT_COUNT_CNS; portIter++)
    {
        ...
        /* AUTODOC: verify routed packet on port 2/3 with: */
    ...
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "ERROR of tgfTrafficGeneratorPortTxEthCaptureSet: %d, &d\n",
                                 prvTgfDevNum, prvTgfPortsArray[nextHopPortNum]);
...
)
{
    ...
    /* restore Transplant data */
    rc =  prvTgfBrgFdbActionTransplantDataSet(&prvTgfUcIpv6RouteTransplantOldInterfaceGet,
                                              &prvTgfUcIpv6RouteTransplantNewInterfaceGet);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbActionTransplantDataSet: %d", prvTgfDevNum);

    /* restore Transplant status */
    rc =  prvTgfBrgFdbRoutingUcTransplantEnableSet(prvTgfDevNum,prvTgfUcIpv6RouteTransplantStatusGet);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbRoutingUcTransplantEnableSet: %d", prvTgfDevNum);

    prvTgfUcIpv6RouteTransplantStatusFirstCall=GT_TRUE;
