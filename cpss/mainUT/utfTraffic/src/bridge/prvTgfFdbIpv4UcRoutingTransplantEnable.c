...
/**
********************************************************************************
* @file prvTgfFdbIpv4UcRoutingTransplantEnable.c
*
* @brief FDB IPv4 UC Routing + Transplant configurations
*
* @version   1
********************************************************************************
*/
...
static GT_BOOL prvTgfUcIpv4RouteTransplantStatusFirstCall=GT_TRUE;/* is this the first call to sav ethe value */
static GT_BOOL prvTgfUcIpv4RouteTransplantStatusGet;

static CPSS_INTERFACE_INFO_STC  prvTgfUcIpv4RouteTransplantOldInterfaceGet;
static CPSS_INTERFACE_INFO_STC  prvTgfUcIpv4RouteTransplantNewInterfaceGet;
...
)
{
    ...
    if(prvTgfUcIpv4RouteTransplantStatusFirstCall==GT_TRUE)
    {
        /* save fdb routing uc Transplant data */
        rc =  prvTgfBrgFdbActionTransplantDataGet(prvTgfDevNum,
                                               &prvTgfUcIpv4RouteTransplantOldInterfaceGet,
                                               &prvTgfUcIpv4RouteTransplantNewInterfaceGet);
        ...
        rc =  prvTgfBrgFdbRoutingUcTransplantEnableGet(prvTgfDevNum,
                                                       &prvTgfUcIpv4RouteTransplantStatusGet);
...
)
{
    ...
    rc =  prvTgfBrgFdbActionTransplantDataSet(&prvTgfUcIpv4RouteTransplantOldInterfaceGet,
                                              &prvTgfUcIpv4RouteTransplantNewInterfaceGet);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbActionTransplantDataSet: %d", prvTgfDevNum);

    /* restore Transplant status */
    rc =  prvTgfBrgFdbRoutingUcTransplantEnableSet(prvTgfDevNum,prvTgfUcIpv4RouteTransplantStatusGet);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbRoutingUcTransplantEnableSet: %d", prvTgfDevNum);

    prvTgfUcIpv4RouteTransplantStatusFirstCall=GT_TRUE;
