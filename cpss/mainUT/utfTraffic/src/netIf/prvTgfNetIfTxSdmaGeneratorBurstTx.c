...
)
{
    ...
    /* AUTODOC: Set queue rate to 10 packets per second */
    ...
    /* AUTODOC: Short burst transmit verification */
    ...
    /* AUTODOC: Long burst transmit verification */
    prvTgfNetIfTxSdmaGeneratorBurstTxPacketsVerify(
                                packetsUpdateArr,
    ...
    rc = prvTgfNetIfSdmaTxGeneratorEnable(prvTgfDevNum,
                                          PRV_TGF_TX_SDMA_GENERATOR_Q_CNS,
                                          GT_TRUE, PRV_TGF_TX_SDMA_GENERATOR_Q_PACKETS_PER_SECOND_CNS*2);
    UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, rc,
                                 "prvTgfNetIfSdmaTxGeneratorEnable: %d, %d, %d",
                                 PRV_TGF_TX_SDMA_GENERATOR_Q_CNS,
                                 GT_TRUE, PRV_TGF_TX_SDMA_GENERATOR_Q_PACKETS_PER_SECOND_CNS*2);
