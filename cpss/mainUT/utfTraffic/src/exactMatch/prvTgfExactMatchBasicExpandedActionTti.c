...
)
{
    ...
    rc = prvTgfTtiRule2Set(PRV_TGF_TTI_INDEX_CNS, PRV_TGF_TTI_RULE_UDB_30_E,
...
)
{
    ...
    rc = prvTgfTtiRule2Set(ruleIndex, ruleType, &mask, &pattern, &action);
    UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, rc, "prvTgfTtiRule2Set FAILED: %d, %d, %d", prvTgfDevNum ,ruleIndex ,ruleType );
}
