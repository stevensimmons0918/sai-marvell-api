...
* @file cmdFS_VIRT.c
*
* @brief Virtual cmdFS implementation - based on single file on real FS
*
* @version   1
********************************************************************************
*/
...
/**
* @internal cmdFSterminate function
* @endinternal
*
* @brief   Close a file descriptor, free memory
*/
...
/**
* @internal cmdFSreadFlash function
* @endinternal
*
