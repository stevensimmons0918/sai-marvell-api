...
* @file IOStream.h
*
* @brief This file contains types and routines for I/O streams
*
* @version   1
********************************************************************************
*/
...
struct IOStreamSTC {
    ...
    *       stream       - destination stream
    *       mode         - terminal mode:
    *                      0: non-blocking for CLI line editing
    *                         terminal signals processed
    *                      1: linemode
    *                      2: raw binary mode, for file transfer
    *
    * OUTPUTS:
    *       None
    *
...
/**
* @internal IOStreamGenericReadLine function
* @endinternal
*
* @brief   Generic readLine method for IOStreamSTC
*         Read line from stream. Perform input editing/translations
*         Returned line is zero terminated with stripped EOL symbols
*/
...
/**
* @internal IOStreamGenericWriteBuf function
* @endinternal
*
* @brief   Generic writeBuf method for IOStreamSTC
*         Write to stream. Perform output translations
*/
int IOStreamGenericWriteBuf(IOStreamPTR streamP, const char *s, int len);

/**
* @internal IOStreamGenericWriteLine function
* @endinternal
*
* @brief   Generic writeLine method for IOStreamSTC
*         Write line to stream. Perform output translations
*/
int IOStreamGenericWriteLine(IOStreamPTR streamP, const char *s);

/**
* @internal IOStreamCreateNULL function
* @endinternal
*
