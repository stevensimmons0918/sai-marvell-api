...
/**
* @internal prvTgfTrafficParseL2Part function
* @endinternal
*
* @brief   Parse buffer to into L2 packet part
*
...
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_SIZE              - on wrong size.
...
/**
* @internal prvTgfTrafficParseEtherTypePart function
* @endinternal
*
* @brief   Parse buffer to into EtherType packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseVlanTagPart function
* @endinternal
*
* @brief   Parse buffer to into VLAN Tag packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseMplsPart function
* @endinternal
*
* @brief   Parse buffer to into MPLS packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseArpPart function
* @endinternal
*
* @brief   Parse buffer to into ARP packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseIpv4Part function
* @endinternal
*
* @brief   Parse buffer to into IPv4 packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseIpv6Part function
* @endinternal
*
* @brief   Parse buffer to into IPv6 packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseTcpPart function
* @endinternal
*
* @brief   Parse buffer to into TCP packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseUdpPart function
* @endinternal
*
* @brief   Parse buffer to into UDP packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseIcmpPart function
* @endinternal
*
* @brief   Parse buffer to into ICMP packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
/**
* @internal prvTgfTrafficParseWildcardPart function
* @endinternal
*
* @brief   Parse buffer to into Wildcard packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
...
* @retval GT_OK                    - on success.
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_NO_RESOURCE           - on ERROR of memory allocation
*/
...
/**
* @internal prvTgfTrafficParsePayloadPart function
* @endinternal
*
* @brief   Parse buffer to into Payload packet part
*
* @param[in] bufferPtr                - (pointer to) the buffer that hold the packet bytes
* @param[in] bufferLength             - the number of bytes in the buffer (not include CRC bytes)
* @param[in,out] packetInfoPtr            - (pointer to) packet fields info
