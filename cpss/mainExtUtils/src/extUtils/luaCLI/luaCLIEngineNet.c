...
/**
********************************************************************************
* @file luaCLIEngineNet.c
*
* @brief network API Lua:
* - tcp.
*
* @version   2
********************************************************************************
...
/**
* @internal l_cpssNetTcp_Connect function
* @endinternal
*
...
/**
* @internal l_cpssNetTcp_Close function
* @endinternal
*
* @brief   close connection
*
* @note tcp.close(descr)  Close connection
*
*/
...
/**
* @internal l_cpssNetTcp_FlushInput function
* @endinternal
*
* @brief   flush input, make sure noting left in buffer (sync)
*
* @note tcp.flushinput(
*       descr
*       )
...
/**
* @internal l_cpssNetTcp_Send function
* @endinternal
*
* @brief   Send string to connection
*
* @note tcp.send(
*       descr,
*       string_to_send
...
/**
* @internal l_cpssNetTcp_Wait function
* @endinternal
*
* @brief   Wait for data available on connection
*
* @retval 1                        - data available
* @retval 0                        - no data available (timeout)
*                                       -1 - error
*
* @note tcp.wait(
*       descr
...
/**
* @internal l_cpssNetTcp_Recv function
* @endinternal
*
* @brief   Wait for data available on connection
*
...
static int l_cpssNetTcp_Recv(lua_State *L)
{
    ...
    lua_pushlstring(L, buf, (size_t)k);
    cpssOsFree(buf);
    return 1;
}

/**
* @internal l_cpssNetTcp_WaitString function
* @endinternal
*
* @brief   Read line from connection. The EOL is \r?\n
*
* @note tcp.waitline(
*       descr
*       [, timeout]
...
/**
* @internal luaCLIEngineNetRegisterAPI function
* @endinternal
*
* @brief   register Network APIs in Lua instance
*/
