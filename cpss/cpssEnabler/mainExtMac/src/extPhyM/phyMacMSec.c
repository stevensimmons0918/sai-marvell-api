...
/**
* @internal macDrvGetSmiAddress function
* @endinternal
*
* @brief   - returns the slice number for cpecified devNum and portNum
*
...
/**
* @internal macDrvGetSlice function
* @endinternal
*
* @brief   - returns the slice number for cpecified devNum and portNum
*
...
/**
* @internal phyMacMSecWriteRegField function
* @endinternal
*
* @brief   This function writes data Value to MacSec register address.
...
/**
* @internal phyMacMSecReadRegField function
* @endinternal
*
* @brief   This function reads data Value from MacSec register address.
*         page number 16 and register 0~3 are defined for indirect access to MACsec address space:
*         reg 0 - ReadAddr
*         reg 1 - WriteAddr
*         reg 2 - Data low 16 bits
...
/**
* @internal phyMacMSecStartCnfgTransaction function
* @endinternal
*
* @brief   This function prepare the MAC to configuration operation.
*         The steps:
...
/**
* @internal phyMacMSecCleanAfterFail function
* @endinternal
*
* @brief   This function:
*         - sets page 0 in PHY
...
)
{
    ...
    GT_UNUSED_PARAM(ssPauseAdvertise);
    GT_UNUSED_PARAM(psPauseAdvertise);
...
* @endinternal
*
* @brief   This function Enable/Disable transmits of periodic 802.3x flow control
...
)
{
    ...
    GT_UNUSED_PARAM(ssState);
    GT_UNUSED_PARAM(psState);
