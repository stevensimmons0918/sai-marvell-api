...
/**
********************************************************************************
* @file shrMemCommonMem.c
*
* @brief This file contains common routines for shared memory management.
...
/**
* @internal extendBufferByOnePage function
* @endinternal
*
* @brief   Function extends buffer described by fd by one page.
*
* @param[in] fd                       - file descriptor of buffer
* @param[in] isAbsoluteOffset         - methos of seeking: absolute (from the begin of file
*                                      or relative).
*
...
*
* @note Page can have any size multiple to OS page (4096 for Linux).
