...
/**
********************************************************************************
* @file osTaskManager.c
*
* @brief functions that implement the task manager for RTOS on simulation.
...
/**
* @internal osTaskManagerFlagsSet function
* @endinternal
*
* @brief   set flags of the task
*
* @param[in] tid                      - Task ID
* @param[in] vip                      - this task is "VIP"
* @param[in] interrupt                - this task is "interrupt"
*
* @retval GT_OK                    - on success
* @retval GT_NOT_FOUND             - task not found
* @retval GT_NOT_INITIALIZED       - DB not initialized
*/
...
/**
* @internal osTaskManagerRegister function
* @endinternal
*
* @brief   register a task into manager
*
* @param[in] tid                      - Task ID
* @param[in] namePtr                  - task name, string no longer then OS_MAX_TASK_NAME_LENGTH
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PTR               - on null pointer
* @retval GT_BAD_PARAM             - on name too long
* @retval GT_FULL                  - table full can't register new task--->
*                                       so need to set larger TASK_MANAGER_DB_SIZE
* @retval GT_ALREADY_EXIST         - task already registered
*/
...
/**
* @internal osTaskManagerUnRegister function
* @endinternal
*
* @brief   un-register a task from manager
*
* @param[in] tid                      - Task ID
*
* @retval GT_OK                    - on success
* @retval GT_NOT_FOUND             - task id is not registered
* @retval GT_NOT_INITIALIZED       - DB not initialized
*/
...
/**
* @internal osTaskManagerSuspendAllExcludeVip function
* @endinternal
*
* @brief   suspend all registered tasks except for some "vip" tasks (and my own)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on failure
* @retval GT_BAD_STATE             - bad state due to trying to suspend task from deferent tid
*                                       then original one.
...
/**
* @internal osTaskManagerResumeAllExcludeVip function
* @endinternal
*
* @brief   Resume all tasks that were suspended by osTaskManagerSuspendAllExcludeVip
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on failure
* @retval GT_BAD_STATE             - bad state due to :
...
/**
* @internal osTaskManagerSuspend function
* @endinternal
*
* @brief   Suspend task in DB .
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on failure
* @retval GT_NOT_FOUND             - task not found
...
/**
* @internal osTaskManagerResume function
* @endinternal
*
* @brief   Resume task in DB .
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on failure
* @retval GT_NOT_FOUND             - task not found
...
/**
* @internal osTaskManagerDump function
* @endinternal
*
*
* @retval GT_OK                    - on success
