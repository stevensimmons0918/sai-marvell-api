...
* @file osShost.c
*
* @brief functions that implement the SHOST for RTOS on simulation.
...
/**
* @internal SHOSTP_is_intrrupt function
* @endinternal
*
* @brief   checks if task is registered as interrupt in DB
*
* @param[in] thd_id                   - task id to be checked if "interrupt" task
*
* @retval 1                        - task is "interrupt"
* @retval 0                        - task is not interrupt
*
* @note NO NEED TO LOCK DB
*
*/
...
* @endinternal
*
* @param[in] new_val                  - new calling task priority
*                                       None
*
* @note The name source is historical.
*
...
* @endinternal
*
* @brief   signal an interrupt to start working
*
* @param[in] intr                     - interrupt number.
*
* @retval 1                        - the interrupt was found in DB
* @retval 0                        - the interrupt was NOT found in DB
*
* @note The name source is historical.
*
*/
