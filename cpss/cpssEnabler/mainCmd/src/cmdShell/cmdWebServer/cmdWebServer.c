...
/**
* @internal l_http_set_responce function
* @endinternal
*
* @brief   registeread as
*         http.set_responce()
...
/**
* @internal l_http_set_header function
* @endinternal
*
* @brief   registeread as
*         http.set_header()
...
/**
* @internal l_http_send_header function
* @endinternal
*
* @brief   registeread as
*         http.send_header()
...
/**
* @internal l_http_print function
* @endinternal
*
* @brief   registeread as
*         print
...
/**
* @internal cmdWebServerInitLuaHTTPEnv function
* @endinternal
*
* @brief   Initialize Lua environment for http services
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/
...
/**
* @internal cmdWebServerHttpReadLine function
* @endinternal
*
* @brief   HTTP protocol implmentation: read line
*         Line must end with \r\n
* @param[in] IOStream                 - I/O stream
* @param[in] L                        - Lua state
* @param[in] buf                      - IOSTREAM_BUFFERED
*
* @param[out] buf
*
* @retval GT_OK                    - on success
...
/**
* @internal cmdWebServerHttpProto function
* @endinternal
*
* @brief   HTTP protocol implmentation
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/
