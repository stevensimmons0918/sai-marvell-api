...
/**
* @internal HttpParser_DecodeUrlEncoded function
* @endinternal
*
* @brief   Decode URL encoded string, Fx sss%2Fttt decoded to sss/ttt
*/
...
/**
* @internal HttpParser_parse_x_www_form_urlencoded function
* @endinternal
*
* @brief   Decode
*         get varialbles,
...
/**
* @internal HttpParser_ParseURL function
* @endinternal
*
* @brief   Parse URL = http://user:pass@host.com:8081/path?var1=val1&var2=val2
*/
...
/**
* @internal HttpParser_ParseQuery function
* @endinternal
*
* @brief   Parse HTTP query string
*         Query example:
...
/**
* @internal parse_rfc822hdr function
* @endinternal
*
* @brief   Parse RFC 822 type header
*/
...
/**
* @internal get_token function
* @endinternal
*
* @brief   get token from begin of string
*/
...
/**
* @internal parse_attr_value_list function
* @endinternal
*
* @brief   Parse the given string for list of attributes:
...
/**
* @internal decode_base64 function
* @endinternal
*
* @brief   Decode rfc2045 base64
...
/**
* @internal valignorecase function
* @endinternal
*
* @brief   Search table of headers. Ignore name case
...
/**
* @internal HttpParser_parse_ct_cd function
* @endinternal
*
* @brief   Parse Content-Type and Content-Disposition headers
...
/**
* @internal HttpParser_parse_multipart_form_data function
* @endinternal
*
...
/**
* @internal HttpParser_getHeader function
* @endinternal
*
* @brief   Get HTTP query header (case insensetive)
*/
...
/**
* @internal HttpParser_ParseHeader function
* @endinternal
*
* @brief   Parse HTTP query header
*/
...
/**
* @internal HttpParser_ParseData function
* @endinternal
*
* @brief   Parse HTTP query data (POST variables, files)
*/
