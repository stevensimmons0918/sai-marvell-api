...
#if !defined(ENV_MAINCMD) && !defined(ENV_POSIX) && !defined(ENV_CPSS)
#  error "No layer defined. Define one of ENV_MAINCMD, ENV_POSIX, ENV_CPSS"
#endif

#ifdef ENV_CPSS
#  include "cmdFS_RAM_cpss.inc"
#endif
#ifdef ENV_MAINCMD
