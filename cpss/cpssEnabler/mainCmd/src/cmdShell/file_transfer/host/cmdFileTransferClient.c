/**
********************************************************************************
* @file cmdFileTransferClient.c
*
* @brief File transfer client program
*
* @version   4
********************************************************************************
*/
...
#else /* WIN32 */
/**
* @internal connectTcp function
* @endinternal
*
* @brief   Connect to remote host
*
* @retval socket or                -1 if error
*/
int connectTcp(const char *host, const char *port)
{
...
* @endinternal
*
* @brief   Wait for a string from connection
*/
...
/**
* @internal send_cmd function
* @endinternal
*
* @brief   Send command to board
*/
...
/**
* @internal wait_ack function
* @endinternal
*
* @brief   Wait command acknowledge
*/
...
/**
* @internal do_ls function
* @endinternal
*
* @brief   execute ls command and print result
*/
...
/**
* @internal do_upload function
* @endinternal
*
* @brief   upload one file to board
*
* @note optind points to current file name
*
*/
...
/**
* @internal do_get function
* @endinternal
*
* @brief   get one file from board
*
* @note optind points to current file name
*
*/
...
/**
* @internal do_delete function
* @endinternal
*
* @brief   delete one file on the board
*
* @note optind points to current file name
*
*/
...
* @endinternal
*
* @brief   Print command line description and exit
*/
