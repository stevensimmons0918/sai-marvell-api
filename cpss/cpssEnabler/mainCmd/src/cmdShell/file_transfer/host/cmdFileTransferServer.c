...
/**
********************************************************************************
* @file cmdFileTransferServer.c
*
* @brief File transfer server program for the host
*
* @version   1
********************************************************************************
*/
...
/**
* @internal socketTcpCreateListen function
* @endinternal
*
* @brief   Create TCP socket, bind it and start listening for incoming connections
*
* @param[in] serverSocket             - the var to save the socket on
*                                      NULL means listen on all interfaces
*                                      port              - tcp port for incoming connections
*
* @param[out] serverSocket             - Store socket descriptior
*
* @retval 0                        - Error
* @retval 1                        - Socket is now open.
*/
...
/**
* @internal parseCommandLine function
* @endinternal
*
* @brief   receives the arguements of the program and translates it to the correct variables
*
* @retval 0                        - Command line parsed correctly
* @retval 1                        - Error.
*/
int parseCommandLine(int argc, char **argv,int *portNum)
{
...
/**
* @internal getCmd function
* @endinternal
*
* @brief   receives the first command from the client and calls the upload/download functions accordingly
*
* @retval 0                        - Action perfeormed correctly.
* @retval 1                        - Error.
*/
int getCmd(int acceptSocket)
{
...
/**
* @internal sockWaitString function
* @endinternal
*
* @brief   Wait for a string from connection (end with a \n)
*/
int sockWaitString(int sock, int timeout, char *buf, int bufsiz)
{
    int p;
...
/**
* @internal do_uploadToBoard function
* @endinternal
*
* @brief   upload one file to board
*
* @note none
*
*/
...
/**
* @internal do_downloadFromBoard function
* @endinternal
*
* @brief   download one file to board
*
* @note none
*
*/
