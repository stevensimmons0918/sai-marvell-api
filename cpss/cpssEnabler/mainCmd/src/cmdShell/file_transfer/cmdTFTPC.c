...
* @file cmdTFTPC.c
*
* @brief TFTP client library implementation
*
* @version   4
********************************************************************************
*/
...
/**
* @internal put_asciiz function
* @endinternal
*
* @brief   put asciiz parameter
*
* @param[in,out] abuf
* @param[in] bufLen
* @param[in,out] offset
...
#define TFTP_PUT    1
/**
* @internal tftp function
* @endinternal
*
* @brief   Sendin/receive file using tftp protocol
*
* @param[in] cmd                      - one of TFTP_GET or TFTP_PUT
* @param[in] server
* @param[in] port
*                                      remoterfile
* @param[in] localfd
*
* @param[out] errorBuf                 at least 128 bytes
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_NOT_FOUND             - local file not found
*/
...
#define const_cast_str(a) ((char*)((GT_UINTPTR)(a)))
    ...
    while (1)
    {
        ...
        do
        {
            ...
            plen = peerAddrLen;
            len = (int)cmdOsSocketRecvFrom(sock,
                    rbuf, sizeof(rbuf),
                    GT_TRUE,
                    peerAddr, &plen);
            if (opcode == TFTP_RRQ || opcode == TFTP_WRQ)
            {
                ...
                cmdOsMemCpy(saAddr, peerAddr, (GT_U32)saAddrLen);
                break;
            }
            if (cmdOsMemCmp(saAddr, peerAddr, (GT_U32)saAddrLen) == 0)
            {
                break;
            }
...
/**
* @internal cmdFS_tftp_put function
* @endinternal
*
* @brief   Send file using tftp protocol
*
* @param[in] server
* @param[in] port
*                                      remoterfile
...
/**
* @internal cmdFS_tftp_get function
* @endinternal
*
* @brief   Receive file using tftp protocol
*
* @param[in] server                   - TFTP  IP
* @param[in] port                     - TFTP server port
*                                      remoterfile - remote file name
* @param[in] localfile                - local file name
* @param[in] compress                 - add GEN_FS_O_COMPRESS for local file
*
* @param[out] errorBuf                 at least 128 bytes
*
* @retval GT_OK                    - on success
