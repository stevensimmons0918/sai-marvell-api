...
/**
********************************************************************************
* @file cmdLuaConfigFile.c
*
* @brief a LUA CLI configuration file support
*
* @version   3
********************************************************************************
*/
...
#ifndef VXWORKS
/**
* @internal prvCopyLocalFile function
* @endinternal
*
* @brief   Copy file on HOST FS
*
* @param[in] srcName                  - source file name eg "/path/to/startup/dir/config.txt"
* @param[in] dstName                  - destication file name eg "/path/to/startup/dir/config.txt.bak"
*                                       GT_OK
*                                       GT_FAIL
*/
...
/**
* @internal cmdCopyFromRAMFStoDisk function
* @endinternal
*
* @brief   copy a file (if exist) from the RAM-FS to the hard-drive
*
* @retval 0                        - on success
*                                       -1 - on failure
*/
...
/**
* @internal prvLoadFileFromLocalFS function
* @endinternal
*
* @brief   Load file from OS filesystem to cmdFS
*
...
/**
* @internal wraplLoadFileFromLocalFS function
* @endinternal
*
* @brief   Load file from OS filesystem to cmdFS (Lua Wrapper)
*/
...
/**
* @internal prvLoadConfigFile function
* @endinternal
*
* @brief   Load configuration file from OS filesystem/tftp server to cmdFS
*/
...
/**
* @internal luaCLI_LoadConfigurationFile function
* @endinternal
*
* @brief   Load configuration file from OS filesystem/tftp server to cmdFS,
*         then execute commands
*
* @param[out] luaInstancePtrPtr
*/
...
)
{
    ...
    if (IOStream == NULL)
        IOStream = IOStreamCreateStdout();

    rc = luaCLIEngine_init(IOStream, &cmdFS,
