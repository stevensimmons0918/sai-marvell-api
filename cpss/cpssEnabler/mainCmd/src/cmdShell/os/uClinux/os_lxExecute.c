...
/**
* @internal modProcStat function
* @endinternal
*
* @brief   Shows process statistics from /proc/mvKernelExt
*/
...
/**
* @internal modSemStat function
* @endinternal
*
* @brief   Shows semaphores statistics from /proc/mvKernelExtSem
*/
