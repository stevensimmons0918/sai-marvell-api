...
/**
********************************************************************************
* @file w32_cmdStreamConsole.c
*
* @brief This file contains mainCmd stream implementation for Win32 console
*
* @version   4
********************************************************************************
*/
...
static int consoleStreamReadChar(IOStreamPTR streamP, char* charPtr, int timeOut)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
    DWORD status, bytes;
...
/**
* @internal cmdStreamCreateWin32Console function
* @endinternal
*
* @brief   Create win32 console stream
*
* @retval stream                   - console/pipe stream
*                                       NULL if error
*/
