...
typedef enum
{
    MYD_DFE_START_ADAPTIVE = 3, /* Launch continous pCAL */
    MYD_DFE_STOP_ADAPTIVE  = 4  /* Stop continous pCAL */
} MYD_DFE_TUNE_MODE;
...
(
 ...
 Description:
    ...
    MYD_DFE_START_ADAPTIVE - Launch continous pCAL 
    MYD_DFE_STOP_ADAPTIVE  - Stop continous pCAL 
