...
/*******************************************************************************
 ...
 Notes/Warnings:
       ...
       Undefine MYD_DEBUG to remove all printing code (may need some modifications
       on some compilers).
...
#define MYD_DBG_ERROR(...)        /* cpssOsPrintf(__VA_ARGS__) */
#define MYD_DBG_INFO(...)         /* cpssOsPrintf(__VA_ARGS__) */
#define MYD_DBG_CRITIC_INFO(...)  /* cpssOsPrintf(__VA_ARGS__) */
