...
/**
* @internal getMode function
* @endinternal
*
* @brief   get mode : basic/enhanced.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal getRingInfo function
* @endinternal
*
* @brief   get rings info.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
* @retval GT_BAD_PARAM             - on bad parameter
* @retval GT_NOT_INITIALIZED       - on missing value
*/
...
/**
* @internal getTrunkSrcPortHashMapping function
* @endinternal
*
* @brief   get trunks 'source port' hash mapping.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
* @retval GT_BAD_PARAM             - on bad parameter
...
/**
* @internal appDemoLion2TrunkSrcPortHashMappingSet_ForMultiCoreFdbLookup function
* @endinternal
*
* @brief   set the trunk srcPort hash mode settings - Lion2.
*
* @param[in] boardRevId               - The board revision Id.
*
* @retval GT_OK                    - on success,
...
/**
* @internal gtDbDxLion2_256kFdb1Ring_MultiCoreFdbPortSetup function
* @endinternal
*
* @brief   CPSS Board specific configurations that should be done after board
*         initialization.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtDbDxLion2_ForMultiCoreFdbLookup_BoardCleanDbDuringSystemReset function
* @endinternal
*
...
* @retval GT_FAIL                  - otherwise.
*/
static GT_STATUS gtDbDxLion2_ForMultiCoreFdbLookup_BoardCleanDbDuringSystemReset
(
    IN  GT_U8   boardRevId
)
{
...
/* fdb Mode */
    fdbMode = CPSS_DXCH_MULTI_PORT_GROUP_FDB_MODE_UNIFIED_LINKED_E;
    FDB256K_1Ring_setup = GT_FALSE;

    rc = genericBoardConfigFun.boardCleanDbDuringSystemReset(boardRevId);
    return rc;
}
...
* @endinternal
*
* @brief   Registration function for the Lion 96XG ports board.
...
)
{
    ...
    boardCfgFuncs->boardCleanDbDuringSystemReset= gtDbDxLion2_ForMultiCoreFdbLookup_BoardCleanDbDuringSystemReset;
...
*/
    ...
    portInitInParam.lbPort = GT_TRUE;
