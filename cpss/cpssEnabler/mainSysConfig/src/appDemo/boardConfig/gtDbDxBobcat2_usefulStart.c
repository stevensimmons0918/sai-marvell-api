...
)
{
    ...
    rc = cpssDxChPortModeSpeedSet(dev, &portsBmp, GT_TRUE,CPSS_PORT_INTERFACE_MODE_SR_LR4_E,CPSS_PORT_SPEED_40000_E);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    {
         { PORT_LIST_TYPE_LIST,      { 64,68,       APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E      }
    ...
    rc = appDemoBc2PortListInit(dev,&portInitlist_240G_40x1G_12x10G_2x40G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    rc = cpssDxChPortDynamicPizzaArbiterIfWorkConservingModeSet(dev,CPSS_DXCH_PA_UNIT_TXQ_0_E,GT_TRUE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    cpssOsPrintf("\n   BW  : %d Gbps",unitBWGbps);
    cpssOsPrintf("\n   Res : %s Mbps",str_speedRes[speedRes]);
    rc = appDemoBc2PortListInit(dev,&portInitlist_240G_40x1G_12x10G_TM_8x40G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    {
         { PORT_LIST_TYPE_LIST,      {  0, 1, 50, 51,  APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E      }
    ...
    rc = appDemoBc2PortListInit(dev,&portInitlist_4x40G_1x1G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    static PortInitList_STC portInitlist_168G_2x40G_2x20G_48x1G[] =
    {
        ...
        ,{ PORT_LIST_TYPE_LIST,      { 80,64,       APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E      }
    ...
    cpssOsPrintf("\n   BW  : %d Gbps",unitBWGbps);
    cpssOsPrintf("\n   Res : %s Mbps",str_speedRes[speedRes]);
    rc = appDemoBc2PortListInit(dev,&portInitlist_168G_2x40G_2x20G_48x1G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    rc = prvCpssDxChPortDynamicPizzaArbiterIfUnitBWSet(dev, CPSS_DXCH_PA_UNIT_ETH_TX_FIFO_0_E, unitBWGbps);
    if (GT_OK != rc)
    {
        return rc;
    }
    ...
    cpssOsPrintf("\n   BW  : %d Gbps",unitBWGbps);
    cpssOsPrintf("\n   Res : %s Mbps",str_speedRes[speedRes]);
    rc = appDemoBc2PortListInit(dev,&portInitlist_8x10G_4x1G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
GT_STATUS pa175Mhz_84Gpbs(GT_VOID)
{
    ...
    {
         { PORT_LIST_TYPE_LIST,      {  0, 1,   2,  3,   APP_INV_PORT_CNS }, CPSS_PORT_SPEED_1000_E,   CPSS_PORT_INTERFACE_MODE_QSGMII_E     }
        ,{ PORT_LIST_TYPE_LIST,      { 52, 56,           APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E     }
        ,{ PORT_LIST_TYPE_EMPTY,     {                   APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,     CPSS_PORT_INTERFACE_MODE_NA_E         }
    };
    ...
    {
         { PORT_LIST_TYPE_LIST,      {  0, 1,   2,  3,   APP_INV_PORT_CNS }, CPSS_PORT_SPEED_1000_E,   CPSS_PORT_INTERFACE_MODE_QSGMII_E     }
        ,{ PORT_LIST_TYPE_LIST,      { 52,               APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E     }
        ,{ PORT_LIST_TYPE_LIST,      { 57, 58, 59, 60,   APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E,  CPSS_PORT_INTERFACE_MODE_SR_LR_E      }
        ,{ PORT_LIST_TYPE_EMPTY,     {                   APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,     CPSS_PORT_INTERFACE_MODE_NA_E         }
    };
    ...
    for (i = 0; i < sizeof(highSpeedPortListConfArr)/sizeof(highSpeedPortListConfArr[0]); i++)
    {
        ...
        rc = prvCpssDxChPortDynamicPATxQHighSpeedPortSet(
            dev, PRV_CPSS_DXCH_PORT_HIGH_SPEED_OPERATION_ASSIGN_E,
            highSpeedPortListConfArr[i].size,&highSpeedPortListConfArr[i].list[0]);
        if (rc != GT_OK)
        {
            return rc;
        }
    ...
    for (i = 0 ; portInitlistArr[i].portInitlistPtr != NULL; i++)
    {
        ...
        rc = appDemoBc2PortListInit(dev,portInitlistArr[i].portInitlistPtr,GT_FALSE);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    cpssOsPrintf("\n   BW  : %d Gbps",unitBWGbps);
    cpssOsPrintf("\n   Res : %s Mbps",str_speedRes[speedRes]);
    rc = appDemoBc2PortListInit(dev,&portInitlist_168G_48x1G_12x10G[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    {
        case 0:
            rc = appDemoBc2PortListInit(dev,&portInitlist_240G_24x10G_SR_LR[0],GT_FALSE);
            if (rc != GT_OK)
            {
                return rc;
            }
            break;
        case 1:
            rc = appDemoBc2PortListInit(dev,&portInitlist_240G_24x10G_KR[0],GT_FALSE);
            if (rc != GT_OK)
            {
                return rc;
            }
...
GT_STATUS testBC2asAC3(GT_VOID)
{
    #define  USER_PORT_NUM0_CNS          0
    #define  USER_PORT_NUM1_CNS          1
    #define  USER_PORT_NUM2_CNS          2
    #define  USER_PORT_NUM3_CNS          3
    #define  USER_PORT_NUM4_CNS          4
    #define  USER_PORT_NUM5_CNS          5
    #define  USER_PORT_NUM6_CNS          6
    #define  USER_PORT_NUM7_CNS          7

    #define  USER_PORT_NUM8_CNS          8
    #define  USER_PORT_NUM9_CNS          9
    #define  USER_PORT_NUM10_CNS        10
    #define  USER_PORT_NUM11_CNS        11

    #define  USER_PORT_NUM12_CNS        12
    #define  USER_PORT_NUM13_CNS        13
    #define  USER_PORT_NUM14_CNS        14
    #define  USER_PORT_NUM15_CNS        15
    #define  NPU_DEBUG_PORT_NUM_CNS     16
    #define  NPU_PORT_NUM_CNS           17
    #define  X86_DEBUG_PORT_NUM_CNS     18
    #define  UPLINK_TO_X86_PORT_NUM_CNS 19


    static CPSS_DXCH_PORT_MAP_STC bc2Map[] =
    { /* Port,                                 mappingType                       portGroup, intefaceNum, txQPort, tmEnable, tmPortInd*/
         { USER_PORT_NUM0_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        0,       0,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM1_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        1,       1,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM2_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        2,       2,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM3_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        3,       3,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM4_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        4,       4,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM5_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        5,       5,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM6_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        6,       6,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM7_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,        7,       7,    GT_FALSE,      GT_NA}

        ,{ USER_PORT_NUM8_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       49,      49,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM9_CNS,         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       48,      48,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM10_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       51,      51,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM11_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       50,      50,    GT_FALSE,      GT_NA}

        ,{ USER_PORT_NUM12_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       59,      59,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM13_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       58,      58,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM14_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       57,      57,    GT_FALSE,      GT_NA}
        ,{ USER_PORT_NUM15_CNS,        CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       56,      56,    GT_FALSE,      GT_NA}


        , { NPU_DEBUG_PORT_NUM_CNS,     CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       63,      63,    GT_FALSE,     GT_NA }
        , { NPU_PORT_NUM_CNS,           CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       52,      52,    GT_FALSE,     GT_NA }
        , { X86_DEBUG_PORT_NUM_CNS,     CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       60,      60,    GT_FALSE,     GT_NA }
        , { UPLINK_TO_X86_PORT_NUM_CNS, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       61,      61,    GT_FALSE,     GT_NA }
        ...
        , { 65,                         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       65,      65,    GT_FALSE,     GT_NA }
        , { 64,                         CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,       0,       64,      64,    GT_FALSE,     GT_NA }
        , { 63/*cpu port for tests*/,   CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,           0,    GT_NA,    62/*!*/, GT_FALSE,     GT_NA }
    };


    static PortInitList_STC portInitlist_bc2[] =
    {
          { PORT_LIST_TYPE_INTERVAL, {  0,  7, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_1000_E,  CPSS_PORT_INTERFACE_MODE_QSGMII_E }
        , { PORT_LIST_TYPE_INTERVAL, { 48, 51, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_1000_E,  CPSS_PORT_INTERFACE_MODE_QSGMII_E }
        , { PORT_LIST_TYPE_INTERVAL, { 56, 59, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E, CPSS_PORT_INTERFACE_MODE_SR_LR_E  }
        , { PORT_LIST_TYPE_INTERVAL, { 64, 71, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E, CPSS_PORT_INTERFACE_MODE_KR_E     }

        , { PORT_LIST_TYPE_INTERVAL, { 52, 52, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_40000_E, CPSS_PORT_INTERFACE_MODE_KR4_E    }
        , { PORT_LIST_TYPE_INTERVAL, { 80, 80, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E, CPSS_PORT_INTERFACE_MODE_KR_E     }
        , { PORT_LIST_TYPE_INTERVAL, { 81, 81, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E, CPSS_PORT_INTERFACE_MODE_KR_E     }
        , { PORT_LIST_TYPE_INTERVAL, { 83, 83, 1, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E, CPSS_PORT_INTERFACE_MODE_KR_E     }
        , { PORT_LIST_TYPE_EMPTY,    {          APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,    CPSS_PORT_INTERFACE_MODE_NA_E     }
    };
    ...
    #ifdef ASIC_SIMULATION
        rc = appDemoBcat2B0SimCoreClockSet(dev,521);
        /* simCoreClockOverwrite(175); */
        if (rc != GT_OK)
        {
            return rc;
        }
        appDemoDebugDeviceIdSet(0, 0xFC0811AB);        /* For Yerkes */
    #endif
    ...
    rc = appDemoBc2PortListInit(dev,&portInitlist_bc2[0],GT_FALSE);
    if (rc != GT_OK)
    {
        return rc;
    }
