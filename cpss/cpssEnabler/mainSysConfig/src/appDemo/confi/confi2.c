...
* @retval GT_OUT_OF_CPU_MEM        - if out of memory
...
/**
* @internal confi2Parse function
* @endinternal
*
* @brief   Parse configuration script loaded to buffer.
*
* @retval GT_OK                    - if there are no problems,
*/
static GT_STATUS confi2Parse()
{
...
#else
    GT_UNUSED_PARAM(theConfiId);
    GT_UNUSED_PARAM(echoOn );
 #endif
    return GT_NOT_SUPPORTED;
}
...
#if 0
/**
* @internal confiFlashReadInt function
* @endinternal
*
* @brief   Read confi binary format from the flash, using the external driver API
*
* @param[in] theOffset                - the flash offset to read from
* @param[in] theLength                - the memory length
*
* @param[out] pTheBuffer               - the memory to read from the flash
*
* @retval GT_OK                    - succeeded
* @retval GT_ERROR                 - failed
*
...
/**
* @internal confiFlashWriteInt function
* @endinternal
*
* @brief   Write confi binary format to the flash, using the external driver API
*
* @param[in] pTheAddress              - the memory to write to the flash
* @param[in] theLength                - the memory length
*
* @retval GT_OK                    - write succeeded
* @retval GT_ERROR                 - write failed
*
* @note Private.
*
*/
...
/**
* @internal confiGetNewCommand function
* @endinternal
*
* @brief   Parse line and return command and fields parameters.
*
* @param[in,out] buf                      - pointer to parsed line.
* @param[in,out] buf                      - point to the last parsed line
*
* @param[out] inBuffer                 - returned command
* @param[out] inFieldBuffer            - returned fields
*
* @retval GT_OK                    - if succeeded,
* @retval GT_FAIL                  - if failed
*/
...
/**
* @internal confiCheckHeader function
* @endinternal
*
* @brief   Check whether script contains right header.
*
* @param[in] line                     - pointer to header line.
*
* @retval GT_OK                    - if succeeded,
* @retval GT_FAIL                  - if failed
*/
...
/**
* @internal confi2LogFltr function
* @endinternal
*
* @brief   Filter log output, remove all Galtis Agent delimiters
*
* @param[in] srcLine                  - input line.
*
* @param[out] outLine                  - filtered line
*
* @retval GT_OK                    - if succeeded,
* @retval GT_FAIL                  - if failed
*/
