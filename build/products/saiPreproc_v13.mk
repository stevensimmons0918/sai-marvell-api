...
PREPROCESSING_V13 := (cd $(REL_TOP)/plugins/sai/sai-v1.3/SAI/saiShell/genScripts && ./preprocessing.sh $(KXDKFLAG))
...
$(PRODUCT):
	...
	@$(ECHO)
	@$(ECHO)
	@$(ECHO) "preprocessing.sh for SAI 1.3 completed succesfully"
	@$(ECHO)
	@$(ECHO)
