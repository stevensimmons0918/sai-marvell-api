...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyRouteNhLagForwarding',
    'description' : 'TC to verify if basic forwarding works through route and nexthopi egressing LAG interface',
    'ingressPort' : ['30'],
    'egressPort' : ['28'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap2',
...
back
neighbor
sai_create_neighbor_entry 9288674231451648 $rif_id_2 0 10.1.1.20 00:02:03:04:05:06
back

nexthop
sai_create_next_hop 9288674231451648 0 $rif_id_2 SAI_NEXT_HOP_TYPE_IP 0 10.1.1.20 >next_hop_id_out1
back
...
back
neighbor
sai_remove_neighbor_entry 9288674231451648 $rif_id_2 0 10.1.1.20
back
routerinterface
...
expectedData = {
       'expect1':'''
'tap0': [<Ether  dst=00:02:03:04:05:06 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=63 proto=hopopt chksum=0xf784 src=192.168.1.10 dst=192.168.2.10 |
'''
}
