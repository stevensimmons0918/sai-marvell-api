...
tcParams = {
    ...
    'tcName' : 'saiVxlanV4L3EVPNRemoteIPv4HostAdd',
...
#
#       'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=7 flags= frag=0 ttl=44 proto=udp chksum=0x82f src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=51048 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0xbb8 reserved2=0x0 |<Ether  dst=00:05:05:05:05:05 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=44 proto=hopopt chksum=0x65dd src=10.10.10.1 dst=20.1.1.1 |
