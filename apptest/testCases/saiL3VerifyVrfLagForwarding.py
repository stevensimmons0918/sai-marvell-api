...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyVrfLagForwarding',
    'description' : 'TC to verify if basic VRF forwarding works through route with ingress as Lag rif and nexthop egressing port rif interface',
    'ingressPort' : ['28'],
    'egressPort' : ['30'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap0',
...
sai_create_lag_member 9288674231451648 281474976710685 $lag_id_1 > lag_member_2
back

routerinterface
sai_create_router_interface 9288674231451648 0 SAI_ROUTER_INTERFACE_TYPE_PORT 281474976710686 $vr_id2 >out_rif
sai_create_router_interface 9288674231451648 0 SAI_ROUTER_INTERFACE_TYPE_PORT $lag_id_1 $vr_id >in_rif
sai_set_router_interface_attribute $in_rif SAI_ROUTER_INTERFACE_ATTR_SRC_MAC_ADDRESS 00:00:01:11:22:33
sai_set_router_interface_attribute $in_rif SAI_ROUTER_INTERFACE_ATTR_SRC_MAC_ADDRESS 00:00:01:11:22:02
sai_set_router_interface_attribute $in_rif SAI_ROUTER_INTERFACE_ATTR_SRC_MAC_ADDRESS 00:00:01:11:22:44
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:44")/scapy_t.IP(dst="192.168.2.10", src="192.168.1.10")
