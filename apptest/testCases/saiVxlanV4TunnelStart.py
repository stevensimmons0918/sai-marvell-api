...
expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=0 flags= frag=0 ttl=45 proto=udp chksum=0x736 src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=51259 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0x7d0 reserved2=0x0 |<Ether  dst=00:00:01:11:22:03 src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=45 proto=hopopt chksum=0x64dd src=20.1.1.1 dst=10.10.10.1 |
        '''
}
