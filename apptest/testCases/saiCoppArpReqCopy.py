...
tcParams = { 
    'ingressPacket' : 'ARPREQUESTPacket',
    'tcName' : 'saiCoppArpReqCopy',
    'description' : 'TC to verify that the ARP REQUEST packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_ARP_REQUEST SAI_PACKET_ACTION_COPY >trp
...
routerinterface
sai_create_router_interface 9288674231451648 0 SAI_ROUTER_INTERFACE_TYPE_PORT 281474976710686 $vr_id6 0 >rif_id_1
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="ff:ff:ff:ff:ff:ff")/scapy_t.ARP(hwsrc="00:00:11:00:11:23",psrc="50.50.1.10",pdst="50.50.2.10",hwdst="ff:ff:ff:ff:ff:ff", op=1)
