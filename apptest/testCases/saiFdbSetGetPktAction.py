...
tcParams = { 
     'ingressPacket' : '', 
     'tcName' : 'saiFdbSetGetPktAction',
     'description' : 'TC to get the packet action after setting the attribute',
     'ingressPort' : [''],
     'egressPort' : [''],
     'pktAction' : '',
...
sai_set_fdb_entry_attribute 9288674231451648 [00:00:00:00:00:49] $vlan100 SAI_FDB_ENTRY_ATTR_PACKET_ACTION 0
