...
tcParams = {
    ...
    'tcName' : 'saiVxlanV4TunnelStartOverEcmp',
    'description' : 'Verify Vxlan tunnel start over Next-hop group',
    'ingressPort' : ['29'],
    'egressPort' : ['28'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
routerinterface
sai_create_router_interface 9288674231451648 $vlan500 SAI_ROUTER_INTERFACE_TYPE_VLAN 0 $vr_id 0 > rif_i_prt_01
...
back
nexthop
sai_create_next_hop 9288674231451648 0 $rif_id_3 SAI_NEXT_HOP_TYPE_IP 0 30.1.1.20 >nh0
sai_create_next_hop 9288674231451648 0 $rif_i_prt_01 SAI_NEXT_HOP_TYPE_IP 0 192.168.2.100 > nh1
back

nexthopgroup
sai_create_next_hop_group 9288674231451648 SAI_NEXT_HOP_GROUP_TYPE_ECMP 0 >nhop_group_id1
sai_create_next_hop_group_member 9288674231451648 $nh0 $nhop_group_id1 0 >nh_group_member_id_1
sai_create_next_hop_group_member 9288674231451648 $nh1 $nhop_group_id1 0 >nh_group_member_id_2
...
back
tunnel
sai_create_tunnel 9288674231451648 $rif_i_prt_01 $tunnel_map2 0 192.168.3.1 SAI_TUNNEL_PEER_MODE_P2P 0 192.168.2.10 SAI_TUNNEL_TYPE_VXLAN $tunnel_map1 > tunnelId
...
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE SAI_TUNNEL_VXLAN_UDP_SPORT_MODE_USER_DEFINED
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT 62000
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE SAI_TUNNEL_VXLAN_UDP_SPORT_MODE_EPHEMERAL
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT 63000
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE SAI_TUNNEL_VXLAN_UDP_SPORT_MODE_USER_DEFINED
...
back
'''
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:03")/scapy_t.Dot1Q(vlan =100)/scapy_t.IP(dst="10.10.10.1", src="20.1.1.2",ttl=45)

#
#expectedData: This dictionary expected egress stream for each egress port.
#
#       'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=1 flags= frag=0 ttl=45 proto=udp chksum=0x735 src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=63000 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0x7d0 reserved2=0x0 |<Ether  dst=00:00:01:11:22:03 src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=45 proto=hopopt chksum=0x64dc src=20.1.1.2 dst=10.10.10.1 |

expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=3 flags= frag=0 ttl=45 proto=udp chksum=0x733 src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=63000 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0x7d0 reserved2=0x0 |<Ether  dst=00:00:01:11:22:03 src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=45 proto=hopopt chksum=0x64dc src=20.1.1.2 dst=10.10.10.1 |
       '''
}
