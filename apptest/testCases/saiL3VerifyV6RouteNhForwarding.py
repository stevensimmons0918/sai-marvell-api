...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyV6RouteNhForwarding',
    'description' : 'TC to verify if basic forwarding works through V6 route and V6 nexthop',
    'ingressPort' : ['30'],
    'egressPort' : ['29'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap2',
...
expectedData = {
       'expect1':'''
'tap1': [<Ether  dst=00:02:03:04:05:06 src=00:00:01:11:22:02 type=IPv6 |<IPv6  version=6 tc=0 fl=0 plen=0 nh=No Next Header hlim=63 src=3ffe:502:4819:: dst=3ffe:501:4819:: |
'''
}
