...
tcParams = {
    ...
    'tcName' : 'ebof_saiCrmIpv4Rocev2ErrorsDrop',
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:02:0a")/scapy_t.Dot1Q(vlan=100)/scapy_t.IP(dst="5.6.7.8", src="1.2.3.4")/scapy_t.UDP(sport=1234,dport=4791)/scapy_t.Raw("\x1100000000000\x61123456789")
