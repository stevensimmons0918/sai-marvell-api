...
tcParams = {
    ...
    'description' : 'TC to verify that the DHCPV6 packet is NOT matched to DHCPV6 trap when the packet action is sent to unknown route',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'DROP',
    'ingressTapIntf' : 'tap2',
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02",type=0x86dd)/scapy_t.IPv6(dst="3fee:0501:4819:0:0:0:0:0", src="3ffe:0502:4819:0:0:0:0:0")/scapy_t.UDP(sport=547,dport=546)
