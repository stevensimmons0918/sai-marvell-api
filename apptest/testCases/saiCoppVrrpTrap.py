...
tcParams = {
    'ingressPacket' : 'VRRP packet',
    'tcName' : 'saiCoppVrrpTrap',
    'description' : 'TC to verify that the Vrrp packet is trapped when the packet action is set to Trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_VRRP SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="01:00:5e:00:00:12",type=0x800)/scapy_t.IP(dst="224.0.0.18", src="10.0.0.1")/scapy_t.VRRP(type=1)
