...
expectedData = {
       'expect1':'''
       'tap2': [<Ether  dst=00:02:03:04:05:06 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=44 proto=hopopt chksum=0xa85 src=192.168.1.10 dst=192.168.2.10 |
        '''
