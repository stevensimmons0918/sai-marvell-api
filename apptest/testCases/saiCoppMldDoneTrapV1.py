...
tcParams = {
    'ingressPacket' : 'MLDv1 Done packet',
    'tcName' : 'saiCoppMLDDoneTrapV1',
    'description' : 'TC to verify that the MLDv1 Done packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_IPV6_MLD_V1_DONE SAI_PACKET_ACTION_TRAP >trp1
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="33:33:ff:f5:00:02",type=0x86dd)/scapy_t.IPv6(dst="ff02::1:fff5:0", src="cc02::1")/scapy_t.ICMPv6MLDone(type=132)
