...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyV4RouteTrap',
    'description' : 'TC to verify if the packet is trapped when the route packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_set_route_entry_attribute 9288674231451648 $vr_id 0 192.168.2.0 [255.255.255.0] SAI_ROUTE_ENTRY_ATTR_PACKET_ACTION SAI_PACKET_ACTION_TRAP
