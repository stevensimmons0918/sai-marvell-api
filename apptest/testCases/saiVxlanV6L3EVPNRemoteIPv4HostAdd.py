...
tcParams = {
    ...
    'tcName' : 'saiVxlanV6L3EVPNRemoteIPv4HostAdd',
    'description' : 'Verify IPv4 tunnel nexthop add in ipv6 vxlan tunnel',
    'ingressPort' : ['29'],
    'egressPort' : ['28'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
sai_set_route_entry_attribute 9288674231451648 $vr_id 0 20.1.1.0 255.255.255.0 SAI_ROUTE_ENTRY_ATTR_NEXT_HOP_ID $nh2
back
