...
tcParams = {
    ...
    'tcName' : 'saiFdbSAiszero',
    'description' : 'TC to verify the drop of packet with zero source mac',
    'ingressPort' : ['29'],
    'egressPort' : ['28','30'],
    'vlan'       : '75',
    'pktAction' : 'DROP',
...
packet_info = scapy_t.Ether(src="00:00:00:00:00:00",dst="00:00:11:00:11:23")/scapy_t.Dot1Q(vlan =75)/scapy_t.IP()
