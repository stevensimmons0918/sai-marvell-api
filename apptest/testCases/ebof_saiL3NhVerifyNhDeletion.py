...
tcParams = { 
    'ingressPacket' : '',
    'tcName' : 'ebof_saiNhVerifyNhDeletion',
    'description' : 'TC to verify if the NH deleted without any issues',
    'ingressPort' : [''],
    'egressPort' : [''],
    'pktAction' : '',
...
back
nexthop
sai_create_next_hop 9288674231451648 0 $rif_id_1 SAI_NEXT_HOP_TYPE_IP 0 20.1.1.1 >next_hop_id_out1
