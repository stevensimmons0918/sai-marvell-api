...
tcParams = { 
    ...
    'tcName' : 'saiL3DropIpCheckLoopbackSip',
...
back
'''
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02")/scapy_t.Dot1Q(vlan =100)/scapy_t.IP(dst="192.168.2.10", src="127.0.0.1")
