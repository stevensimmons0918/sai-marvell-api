...
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_DECAP_TTL_MODE SAI_TUNNEL_TTL_MODE_PIPE_MODEL
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_DECAP_DSCP_MODE SAI_TUNNEL_DSCP_MODE_PIPE_MODEL

sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_DECAP_TTL_MODE SAI_TUNNEL_TTL_MODE_UNIFORM_MODEL
sai_set_tunnel_attribute $tunnelId SAI_TUNNEL_ATTR_DECAP_DSCP_MODE SAI_TUNNEL_DSCP_MODE_UNIFORM_MODEL
...
packet_info =  scapy_t.Ether(src="00:04:04:04:04:49",dst="00:00:01:11:22:02")/scapy_t.IPv6(dst="3ffe:0501:4819:0:0:0:0:0", src="4ffe:0501:4819:0:0:0:0:0",hlim=29,tc=18)/scapy_t.UDP(sport=10, dport=4789)/scapy_t.VXLAN(vni=2000)/scapy_t.Ether(src="00:00:11:00:bb:cc",dst="ff:ff:ff:ff:ff:ff")/scapy_t.Dot1Q(vlan=100)/scapy_t.IP(dst="1.1.1.1", src="2.2.2.2",ttl=50,tos=24)/scapy_t.UDP()
...
expectedData = {
       'expect1':'''
       'tap2': [<Ether  dst=ff:ff:ff:ff:ff:ff src=00:00:11:00:bb:cc type=IPv4 |<IP  version=4 ihl=5 tos=0x18 len=28 id=1 flags= frag=0 ttl=50 proto=udp chksum=0x82b3 src=2.2.2.2 dst=1.1.1.1 |<UDP  sport=domain dport=domain len=0 chksum=0x0 |
        '''
}
