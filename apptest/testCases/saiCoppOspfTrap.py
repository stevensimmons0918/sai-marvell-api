...
tcParams = {
    ...
    'tcName' : 'saiCoppOspfTrap',
    'description' : 'TC to verify that the Ospf packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_OSPF SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="01:00:5e:00:00:05",type=0x800)/scapy_t.IP(dst="224.0.0.5", src="10.0.0.1")/OSPF_Hdr(type=1)/OSPF_Hello()
