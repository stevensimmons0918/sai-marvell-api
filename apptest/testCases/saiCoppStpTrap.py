...
tcParams = { 
    'ingressPacket' : 'STP Packet',
    'tcName' : 'saiCoppStpTrap',
    'description' : 'TC to verify that the STP packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_STP SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(src="00:00:01:00:11:01",dst="01:80:c2:00:00:00")/scapy_t.LLC()/scapy_t.STP(rootid=0,rootmac='00:00:01:00:11:01',bridgeid=0,bridgemac='00:00:01:00:11:01')
