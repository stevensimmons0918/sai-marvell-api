...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyRouteNeigbourDrop',
    'description' : 'TC to verify if the packet is getting dropped when the neighbor packet action is set to SAI_PACKET_ACTION_DROP',
    'ingressPort' : ['30'],
    'egressPort' : ['28'],
    'pktAction' : 'DROP',
    'ingressTapIntf' : 'tap2',
...
sai_set_neighbor_entry_attribute 9288674231451648 $rif_id_1 SAI_IP_ADDR_FAMILY_IPV4 10.1.1.20 SAI_NEIGHBOR_ENTRY_ATTR_PACKET_ACTION SAI_PACKET_ACTION_DROP
back
