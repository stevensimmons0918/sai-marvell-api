...
tcParams = {
    ...
    'tcName' : 'saiVxlanV4L2EVPNRemoteMacAdd',
    'description' : 'Verify L2 EVPN Remote MAC adding',
    'ingressPort' : ['29'],
    'egressPort' : ['28'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
fdb
sai_create_fdb_entry 9288674231451648 [00:00:01:11:02:0b] $vlan100 SAI_PACKET_ACTION_FORWARD 0 192.168.2.10 $brgport SAI_FDB_ENTRY_TYPE_STATIC
'''
...
expectedData = {
    'expect1':'''
        'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=4 flags= frag=0 ttl=45 proto=udp chksum=0x732 src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=49788 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0x7d0 reserved2=0x0 |<Ether  dst=00:00:01:11:02:0b src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=45 proto=hopopt chksum=0x64dd src=20.1.1.1 dst=10.10.10.1 |
         '''
}
