...
tcParams = {
    'ingressPacket' : 'Igmp Report V1 packet',
    'tcName' : 'saiCoppIgmpReportV1Trap',
    'description' : 'TC to verify that the Igmp Report V1 packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_IGMP_TYPE_V1_REPORT SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="33:33:ff:f5:00:02",type=0x800)/scapy_t.IP(dst="224.0.0.1", src="10.0.0.1")/IGMP(type=18)
