...
tcParams = { 
    'ingressPacket' : '',
    'tcName' : 'saiVerifyV4NhMemberRemoveReAdd.py',
    'description' : 'TC to verify if the V4 NH group is created, members are added, removed and re-added properly',
    'ingressPort' : [''],
    'egressPort' : [''],
    'pktAction' : '',
...
sai_create_router_interface 9288674231451648 0 SAI_ROUTER_INTERFACE_TYPE_PORT 281474976710675 $vr_id >rif_i_prt_02

back
neighbor
sai_create_neighbor_entry 9288674231451648 $rif_i_prt_01 0 15.15.15.1 00:00:01:01:01:01
sai_create_neighbor_entry 9288674231451648 $rif_i_prt_02 0 20.20.20.1 00:02:02:02:02:02

back
nexthop
sai_create_next_hop 9288674231451648 0 $rif_i_prt_01 SAI_NEXT_HOP_TYPE_IP 0 15.15.15.1 > nh0
sai_create_next_hop 9288674231451648 0 $rif_i_prt_02 SAI_NEXT_HOP_TYPE_IP 0 20.20.20.1 > nh1
...
neighbor
sai_remove_neighbor_entry 9288674231451648 $rif_i_prt_01 0 15.15.15.1
sai_remove_neighbor_entry 9288674231451648 $rif_i_prt_02 0 20.20.20.1
back
