...
tcParams = {
    ...
    'description' : 'TC to verify that the DHCP packet is CTCd and Forwarded when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : ['29'],
...
expectedData = {
       'expect1':'''
'tap1':[<Ether  dst=ff:ff:ff:ff:ff:ff src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=28 id=1 flags= frag=0 ttl=64 proto=udp chksum=0x7ad1 src=0.0.0.0 dst=255.255.255.255 |<UDP  sport=bootpc dport=bootps len=8 chksum=0xff57
'''
}
