...
tcParams = { 
    'ingressPacket' : '',
    'tcName' : 'saiNhVerifyV4NhGroupCreation',
    'description' : 'TC to verify if the V4 NH group is created and programmed properly',
    'ingressPort' : [''],
    'egressPort' : [''],
    'pktAction' : '',
...
back
neighbor
sai_create_neighbor_entry 9288674231451648 $rif_i_prt_01 0 10.10.10.1 00:01:01:01:01:01
