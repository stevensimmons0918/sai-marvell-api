...
tcParams = {
    ...
    'tcName' : 'saiQosPortPolicerMcStorm',
    'description' : 'TC to verify ingress port policer - unknown multicast storm control',
    'ingressPort' : ['29'],
    'egressPort' : ['28','30'],
    'vlan'       : '75',
    'pktAction' : 'DROP',
...
back
policer
sai_create_policer 9288674231451648 1 0 1 > policer_id1
sai_set_policer_attribute $policer_id1 SAI_POLICER_ATTR_CIR 1000
sai_set_policer_attribute $policer_id1 SAI_POLICER_ATTR_PIR 2000
...
sai_create_policer 9288674231451648 1 0 1 > policer_id2
sai_set_policer_attribute $policer_id2 SAI_POLICER_ATTR_CIR 1000
sai_set_policer_attribute $policer_id2 SAI_POLICER_ATTR_PIR 2000
...
sai_set_policer_attribute $policer_id2 SAI_POLICER_ATTR_YELLOW_PACKET_ACTION 0
...
sai_set_port_attribute 281474976710685 SAI_PORT_ATTR_FLOOD_STORM_CONTROL_POLICER_ID $policer_id2
sai_set_port_attribute 281474976710685 SAI_PORT_ATTR_MULTICAST_STORM_CONTROL_POLICER_ID $policer_id2
sai_get_port_attribute 281474976710685 SAI_PORT_ATTR_MULTICAST_STORM_CONTROL_POLICER_ID 1
'''
...
back
port
sai_set_port_attribute 281474976710685 SAI_PORT_ATTR_FLOOD_STORM_CONTROL_POLICER_ID 0
sai_set_port_attribute 281474976710685 SAI_PORT_ATTR_MULTICAST_STORM_CONTROL_POLICER_ID 0
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:00",dst="01:00:11:00:11:0E")/scapy_t.Dot1Q(vlan =75)/scapy_t.IP()
