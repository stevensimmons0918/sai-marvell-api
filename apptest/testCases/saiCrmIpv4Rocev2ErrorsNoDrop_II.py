...
tcParams = { 
    ...
    'tcName' : 'saiCrmIpv4Rocev2ErrorsNoDrop',
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:02:0a")/scapy_t.Dot1Q(vlan=100)/scapy_t.IP(dst="5.6.7.8", src="1.2.3.4")/scapy_t.UDP(sport=1111,dport=4791)/scapy_t.Raw("\x1100000000000\x63123456789")
...
expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:00:01:11:02:0a src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=50 id=1 flags= frag=0 ttl=64 proto=udp chksum=0x6aa7 src=1.2.3.4 dst=5.6.7.8 |<UDP  sport=1111 dport=4791 len=30 chksum=0x9e65 |
        '''
}
