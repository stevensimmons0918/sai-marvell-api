...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyVrfUnkL3V4MC',
    'description' : 'TC to verify if basic VRF Unknown L3 V4 MC pkt action',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_set_virtual_router_attribute $vr_id SAI_VIRTUAL_ROUTER_ATTR_UNKNOWN_L3_MULTICAST_PACKET_ACTION SAI_PACKET_ACTION_TRAP
...
sai_set_router_interface_attribute $rif_id_1 SAI_ROUTER_INTERFACE_ATTR_V4_MCAST_ENABLE 1
sai_set_router_interface_attribute $rif_id_1 SAI_ROUTER_INTERFACE_ATTR_V4_MCAST_ENABLE 0
sai_set_router_interface_attribute $rif_id_1 SAI_ROUTER_INTERFACE_ATTR_V4_MCAST_ENABLE 1
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:00",dst="01:00:5e:00:00:05")/scapy_t.IP(dst="235.0.0.5", src="5.5.5.5")
