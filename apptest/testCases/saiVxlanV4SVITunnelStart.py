...
tcParams = {
    ...
    'tcName' : 'saiVxlanV4SVITunnelStart',
    'description' : 'Verify Vxlan tunnel start over SVI',
    'ingressPort' : ['29'],
    'egressPort' : ['28'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
sai_create_lag_member 9288674231451648 281474976710684 $lag0 > lag_mem28
...
back
lag
sai_remove_lag_member $lag_mem28
sai_remove_lag $lag0
back
virtualrouter
...
expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:04:04:04:04:49 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=92 id=2 flags= frag=0 ttl=45 proto=udp chksum=0x734 src=192.168.3.1 dst=192.168.2.10 |<UDP  sport=51259 dport=4789 len=72 chksum=0x0 |<VXLAN  flags=Instance reserved1=0 vni=0x7d0 reserved2=0x0 |<Ether  dst=00:00:01:11:22:03 src=00:00:11:00:11:23 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=45 proto=hopopt chksum=0x64dc src=20.1.1.2 dst=10.10.10.1 |
        '''
}
