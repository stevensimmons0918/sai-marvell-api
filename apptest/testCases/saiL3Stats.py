...
tcParams = { 
    ...
    'tcName' : 'saiRifStats',
    'description' : 'TC to verify if RIF Pass stats works with basic forwarding ',
    'ingressPort' : ['29'],
    'egressPort' : ['30'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
sai_create_vlan_member 281474976710686 $vlan_id_200 16325548649218078 >vlan_mbr_30
back
