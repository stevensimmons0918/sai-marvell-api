...
tcParams = {
    ...
    'tcName' : 'saiVxlanV4TunnelTermOverEcmp',
    'description' : 'Verify Vxlan tunnel termination over Next-hop group',
    'ingressPort' : ['31'],
    'egressPort' : ['29'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap3',
...
sai_create_next_hop 9288674231451648 0 $rif_id_3 SAI_NEXT_HOP_TYPE_IP 0 30.1.1.20 >nh1
back
...
back
'''
packet_info = scapy_t.Ether(src="00:04:04:04:04:49",dst="00:00:01:11:22:02")/scapy_t.IP(dst="192.168.3.1", src="192.168.2.10",ttl=55,tos=3)/scapy_t.UDP(sport=63000, dport=4789)/scapy_t.VXLAN(vni=2000)/scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:11:00:11:00")/scapy_t.Dot1Q(vlan=100)/scapy_t.IP(dst="1.1.1.1", src="2.2.2.2",ttl=30)/scapy_t.UDP()
