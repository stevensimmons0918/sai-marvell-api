...
tcParams = {
    ...
    'description' : 'TC to verify that the L2 DHCP packet is trapped when the packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
packet_info = scapy_t.Ether(dst="ff:ff:ff:ff:ff:ff",src="00:00:11:00:11:23",type=0x800)/scapy_t.IP(src ="0.0.0.0",dst="255.255.255.255")/scapy_t.UDP(sport=67,dport=68)
#
