...
tcParams = { 
    ...
    'tcName' : 'saiCoppIp2meTrap',
    'description' : 'TC to verify that the IP2ME packet is trapped when the packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_set_hostif_trap_group_attribute $tgrp SAI_HOSTIF_TRAP_GROUP_ATTR_QUEUE 1
...
sai
policer
sai_create_policer 9288674231451648 SAI_METER_TYPE_PACKETS SAI_POLICER_MODE_SR_TCM SAI_POLICER_COLOR_SOURCE_AWARE >plcr1
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02")/scapy_t.IP(dst="50.50.2.10", src="50.50.1.10")
