...
tcParams = {
    'ingressPacket' : 'UDLDPacket',
    'tcName' : 'saiCoppUdldTrap',
    'description' : 'TC to verify if the UDLD packet is trapped when the packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai
hostif
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_UDLD SAI_PACKET_ACTION_TRAP >trp
