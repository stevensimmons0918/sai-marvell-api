...
tcParams = { 
    'ingressPacket' : '',
    'tcName' : 'ebof_saiNhVerifyV4NeighbourCreation',
...
sai_get_neighbor_entry_attribute 9288674231451648 $rif_id_1 SAI_IP_ADDR_FAMILY_IPV4 20.1.1.1 SAI_NEIGHBOR_ENTRY_ATTR_DST_MAC_ADDRESS 0
'''
