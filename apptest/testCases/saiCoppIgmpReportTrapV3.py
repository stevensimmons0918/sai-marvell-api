...
from scapy.contrib.igmpv3 import IGMP

#tcParams: This dictionary contains parameters to be used, in order to configure specific
#          networking scenario, in future it can be used to auto generate spirent streams.

tcParams = {
    'ingressPacket' : 'Igmp Report V3 packet',
    'tcName' : 'saiCoppIgmpReportV3Trap',
    'description' : 'TC to verify that the Igmp Report V3 packet is trapped when the packet action is set to copy',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_IGMP_TYPE_V3_REPORT SAI_PACKET_ACTION_TRAP >trp
sai_set_hostif_trap_attribute $trp SAI_HOSTIF_TRAP_ATTR_TRAP_GROUP $tgrp
sai_set_hostif_trap_group_attribute $tgrp SAI_HOSTIF_TRAP_GROUP_ATTR_QUEUE 5
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="33:33:ff:f5:00:02",type=0x800)/scapy_t.IP(dst="224.0.0.1", src="10.0.0.1")/IGMP(type=34)
