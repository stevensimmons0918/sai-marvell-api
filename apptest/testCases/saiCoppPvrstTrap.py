...
tcParams = {
    'ingressPacket' : 'PVRSTPacket',
    'tcName' : 'saiCoppPvrstTrap',
    'description' : 'TC to verify if the PVRST packet is trapped when the packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai
hostif
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_PVRST SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(dst="01:00:0c:cc:cc:cc",src="00:00:11:00:11:23")
#
