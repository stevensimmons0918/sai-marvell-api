...
tcParams = { 
    'ingressPacket' : '',
    'tcName' : 'saiVxlanV4L2EVPNRemoteMacGetEndpointIP',
    'description' : 'TC to get the Endpoint IP after creating the fdb entry for tunnel packets',
    'ingressPort' : [''],
    'egressPort' : [''],
    'pktAction' : '',
...
sai_get_fdb_entry_attribute 9288674231451648 [00:00:01:11:02:0b] $vlan100 SAI_FDB_ENTRY_ATTR_ENDPOINT_IP 1
'''
