...
tcParams = { 
    'ingressPacket' : 'BGPPacket',
    'tcName' : 'saiCoppBgpTrap',
...
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_BGP SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02")/scapy_t.IP(dst="50.50.2.10", src="50.50.1.10")/scapy_t.TCP(sport=179, dport=179)
