...
tcParams = {
    'ingressPacket' : 'LACPPacket',
    'tcName' : 'saiCoppLacpTrap',
    'description' : 'TC to verify if the LACP packet is trapped when the packet action is set to trap',
    'ingressPort' : ['30'],
    'egressPort' : [],
    'pktAction' : 'TRAP',
    'ingressTapIntf' : 'tap2',
...
sai
hostif
sai_create_hostif_trap 9288674231451648 SAI_HOSTIF_TRAP_TYPE_LACP SAI_PACKET_ACTION_TRAP >trp
...
packet_info = scapy_t.Ether(dst="01:80:c2:00:00:02",src="00:00:11:00:11:23",type=0x8809)
#
