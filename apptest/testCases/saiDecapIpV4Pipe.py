...
tcParams = { 
    ...
    'tcName' : 'saiIpDecapPipe',
    'description' : 'TC to verify IP V4 Decap with PIPE mode and stats works with basic forwarding ',
    'ingressPort' : ['29'],
    'egressPort' : ['30'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
tunnel
sai_create_tunnel 9288674231451648 0 0 0 [10.10.10.1] SAI_TUNNEL_PEER_MODE_P2MP 0 [0] SAI_TUNNEL_TYPE_IPINIP 0 > tnlId
sai_create_tunnel_term_table_entry 9288674231451648 0 [0.0.0.0] 0 [255.255.255.255] $tnlId SAI_TUNNEL_TYPE_IPINIP 0 [10.10.10.1] SAI_TUNNEL_TERM_TABLE_ENTRY_TYPE_P2MP $vr_id 0 [0.0.0.0] > termId
sai_set_tunnel_attribute $tnlId SAI_TUNNEL_ATTR_DECAP_TTL_MODE SAI_TUNNEL_TTL_MODE_PIPE_MODEL
sai_set_tunnel_attribute $tnlId SAI_TUNNEL_ATTR_DECAP_DSCP_MODE SAI_TUNNEL_DSCP_MODE_PIPE_MODEL
...
back
'''
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02")/scapy_t.Dot1Q(vlan =100)/scapy_t.IP(dst="10.10.10.1", src="20.1.1.1",ttl=45)/scapy_t.IP(dst="192.168.2.10", src="192.168.1.10",ttl=30)
...
expectedData = {
       'expect1':'''
       'tap2': [<Ether  dst=00:02:03:04:05:06 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=29 proto=hopopt chksum=0x1985 src=192.168.1.10 dst=192.168.2.10 |
        '''
