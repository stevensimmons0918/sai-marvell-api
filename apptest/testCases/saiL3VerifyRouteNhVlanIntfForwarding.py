...
tcParams = { 
    ...
    'tcName' : 'saiL3VerifyRouteNhVlanIntfForwarding',
    'description' : 'TC to verify if basic forwarding works through route and nexthopi via router vlan interface',
    'ingressPort' : ['30'],
    'egressPort' : ['29'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap2',
...
back
neighbor
sai_create_neighbor_entry 9288674231451648 $rif_vlan_100 0 10.1.1.20 00:02:03:04:05:06
back

nexthop
sai_create_next_hop 9288674231451648 0 $rif_vlan_100 SAI_NEXT_HOP_TYPE_IP 0 10.1.1.20 >next_hop_id_out1
back
...
expectedData = {
       'expect1':'''
'tap1': [<Ether  dst=00:02:03:04:05:06 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x0 len=20 id=1 flags= frag=0 ttl=63 proto=hopopt chksum=0xf784 src=192.168.1.10 dst=192.168.2.10 |
'''
}
