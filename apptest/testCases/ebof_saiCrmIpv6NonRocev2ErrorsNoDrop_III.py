...
tcParams = { 
    ...
    'tcName' : 'ebof_saiCrmIpv6NonRocev2ErrorsNoDrop',
...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:02:0a")/scapy_t.IPv6(dst="1::1", src="3001::300:3001")/scapy_t.UDP(sport=1111,dport=4791)/scapy_t.Raw("\x1000000000000\x61123456789")
...
expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:00:01:11:02:0a src=00:00:11:00:11:23 type=IPv6 |<IPv6  version=6 tc=0 fl=0 plen=30 nh=UDP hlim=64 src=3001::300:3001 dst=1::1 |<UDP  sport=1111 dport=4791 len=30 chksum=0x4e75 |
        '''
}
