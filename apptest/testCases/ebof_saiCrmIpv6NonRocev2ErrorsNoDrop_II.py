...
packet_info = scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:02:0a")/scapy_t.IPv6(dst="ff02::1", src="fe80::10")/scapy_t.UDP(sport=1111,dport=4791)/scapy_t.Raw("\x1100000000000\x60123456789")
...
expectedData = {
       'expect1':'''
       'tap0':[<Ether  dst=00:00:01:11:02:0a src=00:00:11:00:11:23 type=IPv6 |<IPv6  version=6 tc=0 fl=0 plen=30 nh=UDP hlim=64 src=fe80::10 dst=ff02::1 |<UDP  sport=1111 dport=4791 len=30 chksum=0xb3e4 |
        '''
}
