...
tcParams = {
    ...
    'tcName' : 'saiQosPortPolicerUcStorm',
    'description' : 'TC to verify ingress port policer - unknown unicast storm control',
    'ingressPort' : ['29'],
    'egressPort' : ['28','30'],
    'vlan'       : '75',
    'pktAction' : 'DROP',
...
back
policer
sai_create_policer 9288674231451648 1 1 1 > policer_id1
...
sai_set_policer_attribute $policer_id1 SAI_POLICER_ATTR_PBS 3000
...
sai_get_port_attribute 281474976710685 SAI_PORT_ATTR_FLOOD_STORM_CONTROL_POLICER_ID 1
'''
