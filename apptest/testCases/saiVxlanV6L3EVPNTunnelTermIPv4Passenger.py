...
tcParams = {
    'ingressPacket' : 'Vxlan IPv4 Packet in ipv6 tunnel',
    'tcName' : 'saiVxlanV6L3EVPNTunnelTermIPv4Passenger',
...
'''
packet_info =  scapy_t.Ether(src="00:04:04:04:04:49",dst="00:00:01:11:22:02")/scapy_t.IPv6(dst="3ffe:0501:4819:0:0:0:0:0", src="4ffe:0501:4819:0:0:0:0:0",hlim=29,tc=18)/scapy_t.UDP(sport=10, dport=4789)/scapy_t.VXLAN(vni=3000)/scapy_t.Ether(src="00:00:11:00:11:23",dst="00:00:01:11:22:02")/scapy_t.IP(dst="20.1.1.1", src="2.2.2.2",ttl=30)/scapy_t.UDP()
...
expectedData = {
    'expect1':'''
        'tap1':[<Ether  dst=00:05:05:05:05:05 src=00:00:01:11:22:02 type=IPv4 |<IP  version=4 ihl=5 tos=0x10 len=28 id=1 flags= frag=0 ttl=28 proto=udp chksum=0x85bb src=2.2.2.2 dst=20.1.1.1 |<UDP  sport=domain dport=domain len=0 chksum=0x0 |
        '''
}
